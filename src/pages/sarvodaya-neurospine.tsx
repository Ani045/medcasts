...
const SarvodayaNeuroSpineService = () => {
  ...
  const doctors = [
    {
      ...
      qualifications: "MBBS, MS, MCh (Neurosurgery), Fellowship (Japan)",
      expertise: ["Complex Brain Tumors", "Skull Base Surgery", "Minimally Invasive Neurosurgery"]
    },
    {
      ...
      expertise: ["Brain Tumors", "Stereotactic Radiosurgery", "Functional Neurosurgery"]
    },
    {
      name: "Dr. Vidhu Bhatnagar",
      specialization: "Director, Spine Surgery",
      experience: "20+ years",
      patientsTreated: "7,000+",
      rating: "4.7",
      reviews: "280",
      image: "/dr-dr-aditya-gupta.jpg",
      qualifications: "MBBS, MS (Ortho), Fellowship in Spine Surgery (UK)",
      expertise: ["Complex Spine Deformities", "Minimally Invasive Spine Surgery", "Spinal Tumors"]
    },
    {
      name: "Dr. Sudhir Dubey",
      specialization: "Senior Consultant, Functional Neurosurgery",
      experience: "18+ years",
    ...
    },
    {
      ...
      qualifications: "MBBS, MD, DM (Neuroradiology), Fellowship (USA)",
      expertise: ["Endovascular Neurosurgery", "Stroke Intervention", "Aneurysm Treatment"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After suffering from severe back pain and sciatica for years, I was recommended surgery by several doctors in Canada. Dr. Vidhu Bhatnagar performed minimally invasive decompression surgery that changed my life.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Vidhu Bhatnagar"
    },
    {
      name: "Sarah Williams",
      age: 42,
      ...
      rating: 5,
      story: "When I was diagnosed with a complex meningioma, I sought second opinions and discovered Dr. Sandeep Vaishya at Sarvodaya Hospital. The surgery was successful with complete tumor removal.",
    ...
    },
    {
      ...
      rating: 5,
      story: "After living with Parkinson's disease for 15 years, my neurologist suggested Deep Brain Stimulation and recommended Dr. Sudhir Dubey at Sarvodaya Hospital. The improvement has been remarkable.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Sudhir Dubey"
    },
    {
      name: "Elena Petrova",
      age: 36,
      ...
      rating: 5,
      story: "I was diagnosed with a brain aneurysm during a routine MRI for headaches. Dr. Gaurav Goel performed coiling of my aneurysm through a small incision - no open brain surgery needed!",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Gaurav Goel"
    },
    {
      name: "Michael Brown",
      age: 52,
      ...
      rating: 5,
      story: "I had been suffering from severe neck pain and arm weakness due to cervical disc herniation. Dr. Aditya Gupta recommended artificial disc replacement instead of fusion to maintain motion.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Institute of <span className="text-teal-600">Neurosciences</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced neurosurgical and spine care with cutting-edge technology and experienced specialists at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/sarvodaya.png" 
                    alt="Sarvodaya Hospital & Research Centre - Institute of Neurosciences" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Institute of Neurosciences</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">95% Success</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sarvodaya Hospital & Research Centre Institute of Neurosciences offers advanced neurosurgical and spine care with cutting-edge technology and experienced specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our department is equipped with modern technology including neuronavigation, neuromonitoring, and robotic assistance, allowing our experienced specialists to perform both routine and complex neurological and spine surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive neurological evaluation, advanced imaging studies, and multidisciplinary treatment planning with experienced specialists.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced neurosurgical and spine procedures including minimally invasive and complex surgeries with modern technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-operative care, neuro-rehabilitation programs, and follow-up care with monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced neurospine care with modern technology and experienced team</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Experienced neurospine specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for neurospine consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$6,500</div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I want to book an appointment for neurospine consultation at Sarvodaya Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I need a cost estimate for neurospine surgery at Sarvodaya Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>9+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $325/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">neurospine@sarvodayahospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Experienced Neurospine Care</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default SarvodayaNeuroSpineService;
