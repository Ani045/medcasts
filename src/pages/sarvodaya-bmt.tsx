...
const SarvodayaBMTService = () => {
  ...
  const doctors = [
    ...
    {
      name: "Dr. Vikas Dua",
      specialization: "Senior Consultant, Pediatric Hematology & BMT",
      experience: "20+ years",
    ...
    },
    {
      ...
      experience: "18+ years",
      patientsTreated: "1,300+",
      rating: "4.7",
      reviews: "190",
      image: "/dr-dr-aditya-gupta.jpg",
      qualifications: "MBBS, MD, DM Clinical Hematology",
      expertise: ["Allogeneic Transplants", "Multiple Myeloma", "Aplastic Anemia"]
    },
    {
      name: "Dr. Neha Rastogi",
      specialization: "Consultant, Hematology & BMT",
      experience: "15+ years",
      ...
      qualifications: "MBBS, MD, DM Clinical Hematology",
      expertise: ["Autologous Transplants", "Lymphoma Management", "Myelodysplastic Syndromes"]
    },
    {
      name: "Dr. Satyendra Katewa",
      specialization: "Consultant, Pediatric Hematology & BMT",
      experience: "16+ years",
      patientsTreated: "1,200+",
      rating: "4.7",
      reviews: "180",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD Pediatrics, Fellowship Pediatric Hematology-Oncology",
      expertise: ["Pediatric BMT", "Childhood Leukemia", "Hemoglobinopathies"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with multiple myeloma, I researched extensively for treatment options. Sarvodaya Hospital's BMT unit came highly recommended. Dr. Rahul Bhargava and his team provided exceptional care throughout my treatment journey.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Our daughter was diagnosed with thalassemia major and needed a bone marrow transplant. Dr. Vikas Dua's expertise in pediatric BMT was remarkable. The care gave our daughter a second chance at life.",
    ...
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with acute myeloid leukemia and needed a bone marrow transplant. Dr. Sanjeev Kumar Sharma recommended a haploidentical transplant using my brother's stem cells. The procedure was successful.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Sanjeev Kumar Sharma"
    },
    {
      name: "Emily Thompson",
      age: 42,
      ...
      treatment: "Autologous Bone Marrow Transplant",
      rating: 5,
      story: "After being diagnosed with non-Hodgkin lymphoma, I needed a bone marrow transplant. Dr. Neha Rastogi and her team at Sarvodaya Hospital provided exceptional care throughout my treatment journey.",
    ...
    },
    {
      ...
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "Our son was diagnosed with severe aplastic anemia and needed a bone marrow transplant. Dr. Satyendra Katewa's expertise in pediatric BMT was remarkable. The care gave our son a second chance at life.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Satyendra Katewa"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced BMT facility with cutting-edge stem cell therapies and comprehensive hematological care at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/sarvodaya.png" 
                    alt="Sarvodaya Hospital & Research Centre - BMT Center of Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Sarvodaya Hospital & Research Centre</h3>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">1,200+ Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦠</div>
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">80% Success</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">IGI Airport (DEL) - Easy connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Delhi Metro Connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">Strategic Location</div>
                      <div className="text-sm text-gray-600">Sector 8, Faridabad</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.123456789!2d77.3212345!3d28.3912345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cdccaaaaaaab%3A0x404085140375fa29!2sSarvodaya%20Hospital%20Research%20Centre!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sarvodaya Hospital & Research Centre BMT Center of Excellence offers advanced BMT facility with cutting-edge stem cell therapies and comprehensive hematological care at affordable costs with experienced specialists.
                </p>
                <p>
                  The BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 1,200 successful procedures and outcomes matching international benchmarks.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive evaluation, HLA typing, donor matching, and pre-transplant conditioning with experienced hematologists.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced bone marrow transplant procedures including autologous, allogeneic, and immunotherapy with state-of-the-art facilities.
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919810123456?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced BMT care with cutting-edge stem cell therapies and expert team</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Experienced BMT specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  <h3 className="font-bold text-blue-800 mb-3">Why Choose MedCasts with Sarvodaya</h3>
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    ...
                    <div>
                      ...
                      <p>✓ 4.7/5 rating from 3,000+ patients</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $140</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I want to book an appointment for BMT consultation at Sarvodaya Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I need a cost estimate for BMT at Sarvodaya Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $700/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-98101-23456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">bmt@sarvodayahospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Sector 8, Faridabad</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+919810123456', '_blank')}
                >
                  Emergency: +91-98101-23456
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Experienced BMT Center</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default SarvodayaBMTService;
