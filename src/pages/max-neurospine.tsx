...
const MaxNeuroSpineService = () => {
  ...
  const doctors = [
    {
      name: "Dr. Anil Kansal",
      specialization: "Chairman, Institute of Neurosciences",
      experience: "30+ years",
    ...
    },
    {
      ...
      specialization: "Senior Director, Spine Surgery",
      experience: "22+ years",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After suffering from severe back pain and sciatica for years, I was recommended surgery by several doctors in the UK. Dr. Rajiv Chawla performed minimally invasive decompression surgery that changed my life.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Rajiv Chawla"
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with a complex meningioma, I sought second opinions and discovered Dr. Anil Kansal at Max Hospital. The surgery was successful with complete tumor removal and no neurological deficits.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Anil Kansal"
    },
    {
      ...
      rating: 5,
      story: "After living with Parkinson's disease for 14 years, my neurologist suggested Deep Brain Stimulation and recommended Dr. Rohit Bansil at Max Hospital. The improvement in my symptoms has been remarkable.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Rohit Bansil"
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with a brain aneurysm during a routine MRI for headaches. Dr. Vikas Gupta performed coiling of my aneurysm through a small incision in my groin - no open brain surgery needed!",
    ...
    },
    {
      ...
      rating: 5,
      story: "I had been suffering from severe neck pain and arm weakness due to cervical disc herniation. Dr. Rajiv Chawla recommended artificial disc replacement instead of fusion to maintain motion.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/max.png" 
                    alt="Max Super Speciality Hospital - Institute of Neurosciences" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Max Super Speciality Hospital's Institute of Neurosciences offers world-class neurosurgical and spine care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our department is equipped with the latest technology including intraoperative neuronavigation, neuromonitoring, intraoperative MRI, and robotic assistance, allowing our internationally trained specialists to perform both routine and complex neurological and spine surgeries with excellent outcomes.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$7,800</div>
                  <div className="text-sm text-gray-500">Consultation from $78</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for neurospine consultation at Max Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for neurospine surgery at Max Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $390/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">neurospine@maxhealthcare.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
...
export default MaxNeuroSpineService;
