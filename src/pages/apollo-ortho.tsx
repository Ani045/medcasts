...
const ApolloOrthoService = () => {
  ...
  const doctors = [
    ...
    },
    {
      ...
      qualifications: "MBBS, MS Ortho, Fellowship Spine Surgery",
      expertise: ["Spinal Fusion", "Disc Replacement", "Minimally Invasive Spine"]
    },
    {
      ...
      expertise: ["ACL Reconstruction", "Shoulder Surgery", "Athletic Injuries"]
    },
    {
      name: "Dr. Vikram Sharma",
      specialization: "Robotic Surgery Specialist",
      experience: "22+ years",
      patientsTreated: "3,200+",
      rating: "4.9",
      reviews: "176",
      image: "/dr-dr-i-p-s-oberoi.jpg",
      qualifications: "MBBS, MS Ortho, Fellowship Robotic Surgery",
      expertise: ["Robotic Joint Replacement", "Computer Navigation", "Precision Surgery"]
    },
    {
      ...
      qualifications: "MBBS, MS Ortho, Fellowship Hip & Knee Surgery",
      expertise: ["Hip Replacement", "Knee Surgery", "Revision Arthroplasty"]
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Robotic Orthopaedic Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced robotic surgery, sports medicine expertise, and comprehensive spine care with cutting-edge technology.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="https://newoaks.s3.us-west-1.amazonaws.com/AutoDev/17785/a094aa78-bb4f-4a21-8a32-bbe9f39be0f6.png" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Robotic & Sports Medicine Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🤖 Robotic Surgery</h4>
                        <p className="text-xs opacity-90">Precision Technology</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">Precision Technology</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">⚽</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Sports Medicine</div>
                  <div className="text-xs text-gray-600">Athletic Care</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦴</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Jasola Apollo Metro Station</div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo's Orthopaedics Department is a pioneer in robotic surgery and sports medicine, offering comprehensive care with state-of-the-art technology and expert specialists.
                </p>
                <p>
                  Our specialized teams in robotic joint replacement, sports medicine, and spine surgery provide world-class treatment with precision technology and personalized rehabilitation programs.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911129871013?text=Hi, I'd like to know more about ${treatment.name} at Apollo Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Robotic operation theater</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911129871013?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Robotic orthopedic procedures require comprehensive travel insurance covering advanced surgical procedures, personal accidents, and emergency medical evacuation.
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    <li>• Bring all previous medical records and imaging studies</li>
                    <li>• Plan for sports rehabilitation if applicable</li>
                    <li>• Coordinate with robotic surgery team</li>
                    <li>• Arrange for international patient services</li>
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    <div>
                      <p>✓ Robotic surgery expertise</p>
                      <p>✓ Sports medicine specialists</p>
                      <p>✓ Advanced spine surgery</p>
                    </div>
                    <div>
                      <p>✓ NABH accredited facility</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911129871013?text=Hi, I want to book an appointment for orthopedic consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911129871013?text=Hi, I need a cost estimate for orthopedic treatment at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>2+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91 11 2987 1013</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">ortho@apollodelhi.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency orthopedic services with robotic surgery capabilities and immediate response team
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+911129871000', '_blank')}
                >
