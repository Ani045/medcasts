  ...
  const doctors = [
    {
      ...
      specialization: "Chief, GI Surgery & Solid Organ Transplant",
      experience: "30+ years",
    ...
    },
    {
      ...
      specialization: "Senior Consultant, GI & HPB Surgery",
      experience: "25+ years",
      ...
      expertise: ["Colorectal Surgery", "Minimally Invasive Surgery", "GI Oncology"]
    },
    {
      name: "Dr. Prakash K",
      specialization: "Senior Consultant, Bariatric & Metabolic Surgery",
      experience: "20+ years",
      ...
      expertise: ["Bariatric Surgery", "Metabolic Surgery", "Laparoscopic Surgery"]
    },
    {
      name: "Dr. Shabeer Ali T.U.",
      specialization: "Consultant, GI & HPB Surgery",
      experience: "15+ years",
      patientsTreated: "3,500+",
      rating: "4.8",
      reviews: "210",
      image: "/dr-dr-i-p-s-oberoi.jpg",
      qualifications: "MBBS, MS, Fellowship in HPB Surgery",
      expertise: ["Hepatobiliary Surgery", "Pancreatic Surgery", "Minimally Invasive Surgery"]
    },
    {
      name: "Dr. Naveen Ganjoo",
      specialization: "Consultant, GI & Colorectal Surgery",
      experience: "18+ years",
      patientsTreated: "4,200+",
      rating: "4.7",
      reviews: "180",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MS, Fellowship in Colorectal Surgery",
      expertise: ["Colorectal Cancer", "Inflammatory Bowel Disease", "Minimally Invasive Surgery"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      age: 58,
      country: "USA",
      treatment: "Laparoscopic Liver Resection for Metastatic Colorectal Cancer",
      rating: 5,
      story: "After being diagnosed with colorectal cancer that had spread to my liver, I researched treatment options globally. Amrita Hospital's reputation for liver surgery led me to Dr. Sudhindran. The multidisciplinary approach was impressive.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Sudhindran S"
    },
    {
      name: "Emily Thompson",
      age: 45,
      ...
      rating: 5,
      story: "After struggling with obesity and type 2 diabetes for years, I decided to undergo bariatric surgery. I chose Amrita Hospital after thorough research and consultation with Dr. Prakash K, who specializes in bariatric procedures.",
    ...
    },
    {
      ...
      age: 62,
      country: "UAE",
      treatment: "Whipple Procedure for Pancreatic Cancer",
      rating: 5,
      story: "When I was diagnosed with pancreatic cancer, I knew I needed the best possible care. After consultations in multiple countries, I chose Amrita Hospital for Dr. Sudhindran's expertise in pancreatic surgery.",
    ...
    },
    {
      ...
      age: 52,
      country: "Russia",
      treatment: "Colorectal Surgery for Rectal Cancer",
      rating: 5,
      story: "After my rectal cancer diagnosis, I researched treatment options globally and chose Amrita Hospital for their expertise in colorectal surgery. Dr. Ramesh Rajan performed a minimally invasive procedure.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Ramesh Rajan"
    },
    {
      name: "John Peterson",
      age: 50,
      ...
      rating: 5,
      story: "I had been suffering from a complex ventral hernia that had recurred after previous surgeries. After consulting with several surgeons in Canada, I was referred to Amrita Hospital and Dr. Prakash K.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  GI Surgery Center of <span className="text-teal-600">Excellence</span>
                </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/amrita.png" 
                    alt="Amrita Hospital - GI Surgery Center of Excellence" 
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">GI Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Laparoscopic Surgery</div>
                  <div className="text-xs text-gray-600">Minimally Invasive</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🫀</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Liver Transplant</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">45 minutes from Cochin Airport</div>
                      <div className="text-sm text-gray-600">COK Airport (Cochin) - International connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Kochi Metro Connectivity</div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Amrita GI Surgery Center of Excellence offers world-class gastrointestinal surgical care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our GI Surgery department is equipped with the latest technology including advanced laparoscopic systems and staffed by internationally trained specialists who perform both routine and complex GI surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive GI evaluation, advanced imaging studies, and multidisciplinary treatment planning with internationally trained specialists.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced gastrointestinal surgical procedures including minimally invasive, laparoscopic, and complex surgeries with cutting-edge technology.
                    </div>
                  )}
                </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919846789123?text=Hi, I'd like to know more about ${treatment.name} at Amrita Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919846789123?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846789123?text=Hi, I want to book an appointment for GI surgery consultation at Amrita Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846789123?text=Hi, I need a cost estimate for GI surgery at Amrita Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>15+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $50/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-98467-89123</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">gi.surgery@aims.amrita.edu</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+919846789123', '_blank')}
                >
                  Emergency: +91-98467-89123
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Advanced Laparoscopic Technology</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default AmritaGISurgeryService;
