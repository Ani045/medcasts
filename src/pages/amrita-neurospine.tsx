  ...
  const doctors = [
    {
      ...
      specialization: "Head, Department of Neurosurgery",
      experience: "25+ years",
      ...
      expertise: ["Complex Brain Tumors", "Skull Base Surgery", "Cerebrovascular Surgery"]
    },
    {
      name: "Dr. Santhosh George",
      ...
      qualifications: "MBBS, MS, MCh (Neurosurgery), Fellowship (UK)",
      expertise: ["Neuro-oncology", "Stereotactic Radiosurgery", "Pediatric Neurosurgery"]
    },
    {
      name: "Dr. Suresh Nair",
      ...
      qualifications: "MBBS, MS (Ortho), Fellowship in Spine Surgery (Germany)",
    ...
    },
    {
      ...
      specialization: "Senior Consultant, Neuro-intervention",
      experience: "15+ years",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After years of debilitating back pain and leg numbness, I was recommended surgery by multiple specialists in the US. The cost estimates were astronomical, so I researched international options. Dr. Suresh Nair performed a minimally invasive decompression that immediately relieved my symptoms.",
    ...
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with a complex meningioma, I was told by doctors in Germany that the surgery carried significant risks. After researching international options, I discovered Dr. Mathew Abraham at Amrita Hospital. The surgery was successful with complete tumor removal.",
      image: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Mathew Abraham"
    },
    {
      name: "Ahmed Al-Farsi",
      age: 65,
      ...
      rating: 5,
      story: "After living with Parkinson's disease for 12 years, my symptoms were becoming increasingly difficult to control with medication. Dr. Shyam Sundar at Amrita Hospital performed Deep Brain Stimulation with remarkable results.",
      image: "https://images.unsplash.com/photo-1566753323558-f4e0952af115?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Shyam Sundar"
    },
    {
      name: "Elena Petrova",
      age: 36,
      ...
      rating: 5,
      story: "I was diagnosed with a brain aneurysm during a routine MRI for headaches. Dr. Sajesh K. Menon at Amrita Hospital performed coiling of my aneurysm through a small incision - no open brain surgery needed! I was amazed at how quickly I recovered.",
      image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Sajesh K. Menon"
    },
    {
      ...
      rating: 5,
      story: "I had been suffering from severe neck pain and arm weakness due to cervical disc herniation. The waiting time for surgery in Canada was over a year, so I researched international options. Dr. Suresh Nair recommended artificial disc replacement instead of fusion.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Centre for <span className="text-teal-600">Neurosciences Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  World-class neurosurgical and spine care with cutting-edge technology and internationally trained specialists at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/amrita.png" 
                    alt="Amrita Hospital - Centre for Neurosciences Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Centre for Neurosciences</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">International Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Amrita Centre for Neurosciences offers world-class neurosurgical and spine care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our department is equipped with the latest technology including intraoperative neuronavigation, neuromonitoring, intraoperative MRI, and robotic assistance, allowing our internationally trained specialists to perform both routine and complex neurological surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">Neuro Spine Surgery</span>
                    </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919846123456?text=Hi, I'd like to book an appointment with ${doctor.name} for neurospine consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846123456?text=Hi, I want to book an appointment for neurospine consultation at Amrita Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846123456?text=Hi, I need a cost estimate for neurospine surgery at Amrita Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">neurosciences@aims.amrita.edu</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
...
export default AmritaNeuroSpineService;
