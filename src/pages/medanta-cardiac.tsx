  ...
  const treatments = [
    {
      ...
      cost: "$5,800 - $8,500",
      description: "Advanced minimally invasive procedure to open blocked coronary arteries using latest balloon catheter and premium stent placement",
      duration: "2-3 hours",
      stay: "2-3 days"
    },
    {
      ...
      cost: "$10,500 - $15,500",
      description: "Premium surgical procedure to create new pathways around blocked coronary arteries using advanced grafts and techniques",
      duration: "4-6 hours",
      stay: "7-10 days"
    },
    {
    ...
    },
    {
      ...
      cost: "$8,200 - $12,000",
      description: "Implantation of advanced electronic device to regulate heart rhythm and treat complex arrhythmias",
      duration: "1-2 hours",
      stay: "1-2 days"
    },
    {
    ...
    },
    {
      ...
      cost: "$13,500 - $20,500",
      description: "Advanced replacement of diseased aortic valve with premium prosthetic valve using latest surgical methods",
      duration: "3-5 hours",
      stay: "8-12 days"
    },
    {
  ...
  const doctors = [
    {
      ...
      qualifications: "MBBS, MS, FRCS, Padma Bhushan",
      expertise: ["Complex Cardiac Surgery", "Heart Transplant", "Pediatric Cardiac Surgery"]
    },
    {
      ...
      expertise: ["Complex Angioplasty", "Structural Heart Disease", "Coronary Interventions"]
    },
    {
      ...
      qualifications: "MBBS, MS, MCh Pediatric Cardiac Surgery",
      expertise: ["Congenital Heart Surgery", "Pediatric Heart Transplant", "Neonatal Cardiac Surgery"]
    },
    {
      ...
      expertise: ["Arrhythmia Treatment", "Device Implantation", "Catheter Ablation"]
    },
    {
      name: "Dr. Ashok Seth",
      ...
      qualifications: "MBBS, MD, FRCP, FACC, FSCAI",
      expertise: ["Interventional Cardiology", "Complex PCI", "Structural Heart Disease"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Exceptional cardiac care at Medanta Hospital. The angioplasty was performed with precision and the facilities are world-class. Dr. Trehan is truly remarkable and the nursing staff provided excellent support throughout my stay.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Outstanding surgical expertise and comprehensive care at Medanta Hospital. The valve replacement surgery was flawless and recovery was smooth with excellent nursing support. The international patient services were exceptional.",
    ...
    },
    {
      ...
      rating: 5,
      story: "World-class cardiac surgery center at Medanta Hospital. The CABG procedure was performed excellently with state-of-the-art technology and exceptional post-operative care. The facilities exceeded my expectations.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Rajesh Khanna performed life-saving congenital heart surgery on our daughter with incredible skill and compassion. The pediatric cardiac team at Medanta Hospital provided exceptional care for our family.",
    ...
    },
    {
      ...
      age: 55,
      country: "USA",
      treatment: "Complex Angioplasty",
      rating: 5,
      story: "Dr. Sushma Sharma's expertise in interventional cardiology was remarkable. The complex angioplasty procedure at Medanta Hospital was performed with precision and the follow-up care was comprehensive.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Sushma Sharma"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-teal-600 font-medium">Cardiac Care</span>
              </div>
              
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Premier Cardiac Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  India's leading cardiac care center with world-renowned surgeons, cutting-edge technology, and comprehensive heart treatments.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/medanta.png" 
                    alt="Medanta Hospital - Premier Cardiac Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Premier Heart Care</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">World-class Equipment</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="World-renowned Cardiac Team" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">👨‍⚕️ World-class Team</h4>
                        <p className="text-xs opacity-90">Renowned Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Cardiac Excellence</div>
                  <div className="text-xs text-gray-600">Premier Heart Care</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🔬</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Advanced Technology</div>
                  <div className="text-xs text-gray-600">World-class Equipment</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">👨‍⚕️</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">World-class Team</div>
                  <div className="text-xs text-gray-600">Renowned Doctors</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Huda City Center Metro</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.123456789!2d77.0923456!3d28.4123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d19aaaaaaab%3A0x404085140375fa29!2sMedanta%20The%20Medicity%20Gurugram!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Medanta - The Medicity is a premier multi-specialty medical institute in Gurugram, renowned for its world-class cardiac care. Our Heart Institute is equipped with state-of-the-art technology and advanced catheterization labs.
                </p>
                <p>
                  Led by Dr. Naresh Trehan and our team of internationally trained cardiac specialists, we provide comprehensive heart treatments with cutting-edge technology and personalized care protocols for optimal patient outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac evaluation, advanced imaging studies, and personalized treatment planning with world-class expertise.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">Cardiac Treatment</span>
                    </div>
                    {expandedSection === 'treatment' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced cardiac procedures including angioplasty, bypass surgery, valve repairs, and minimally invasive interventions with cutting-edge technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac rehabilitation, lifestyle counseling, and recovery programs with world-class monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911244141414?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Premium cardiac care with world-class expertise and technology</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• World-class surgeon fees</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Medications & lifestyle counseling</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">World-renowned cardiac specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911244141414?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Advanced cardiac procedures require comprehensive travel insurance covering surgical procedures, emergency interventions, and medical evacuation.
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    <li>• Patients must arrive at least 2 days before procedure for pre-assessment</li>
                    <li>• Bring all medical records, ECGs, and previous cardiac reports</li>
                    ...
                    <li>• Post-procedure cardiac rehabilitation is essential for optimal recovery</li>
                  </ul>
                </div>
                ...
                <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    <p>• For procedures scheduled within 30 days, full payment is required</p>
                    <p>• For procedures beyond 30 days, 30% advance payment to confirm booking</p>
                    <p>• Cancellations 15+ days before procedure: 75% refund (excluding booking fee)</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$5,200</div>
                  <div className="text-sm text-gray-500">Consultation from $75</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244141414?text=Hi, I want to book an appointment for cardiac consultation at Medanta Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244141414?text=Hi, I need a cost estimate for cardiac treatment at Medanta Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>22+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $280/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-124-4141414</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">cardiac@medanta.org</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency cardiac services with immediate response team and world-class cardiac life support
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+911244141414', '_blank')}
                >
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>World-Class Cardiac Care</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Internationally Trained Surgeons</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default MedantaCardiacService;