  ...
  const doctors = [
    {
      ...
      expertise: ["Breast Cancer", "GI Oncology", "Robotic Surgery"]
    },
    {
      name: "Dr. Anita Mathur",
    ...
    },
    {
      ...
      expertise: ["Blood Cancers", "Bone Marrow Transplant", "Lymphoma Treatment"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Apollo's oncology team provided exceptional care during my prostate cancer treatment. The robotic surgery was precise and my recovery was remarkably smooth. The international patient services made everything seamless.",
    ...
    },
    {
      ...
      rating: 5,
      story: "The comprehensive breast cancer treatment at Apollo was outstanding. Dr. Sharma's expertise and the nursing team's care made my journey much easier. The world-class facilities exceeded my expectations.",
    ...
    },
    {
      ...
      rating: 5,
      story: "The precision radiation therapy at Apollo was exceptional. Dr. Jalali's expertise in IGRT technology ensured targeted treatment with minimal side effects. The care coordination was impeccable throughout.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Rakesh Jalali"
    },
    {
      name: "Sarah Martinez",
      age: 42,
      ...
      rating: 5,
      story: "Dr. Meenu Walia's expertise in gynecologic oncology was remarkable. The minimally invasive approach and comprehensive care at Apollo Hospital made my treatment experience as comfortable as possible.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Vinod Raina's expertise in hemato-oncology saved my life. The bone marrow transplant procedure at Apollo was performed with utmost precision. The post-treatment care was exceptional.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Cancer Care Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  World-class cancer care with pioneering surgical techniques, advanced radiation therapy, and comprehensive treatment protocols.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/apollo.png" 
                    alt="Apollo Hospital - World-class Oncology Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Comprehensive Cancer Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🔬 Pioneering Technology</h4>
                        <p className="text-xs opacity-90">Advanced Treatment</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🏥 World-class Care</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo Cancer Institute is a world-class comprehensive cancer center offering pioneering surgical, medical, and radiation oncology services with international standards of care.
                </p>
                <p>
                  Our globally renowned team of oncologists and state-of-the-art technology provide personalized treatment plans with exceptional outcomes and compassionate patient care.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced surgical procedures, chemotherapy, radiation therapy, and targeted treatments with pioneering technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-treatment care, supportive services, and rehabilitation programs with international standards.
                    </div>
                  )}
                </div>
              </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911126925858?text=Hi, I'd like to book an appointment with ${doctor.name} for oncology consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    ...
                    <p>• Cancellations 15+ days before treatment: 70% refund (excluding booking fee)</p>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911126925858?text=Hi, I want to book an appointment for oncology consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911126925858?text=Hi, I need a cost estimate for cancer treatment at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $240/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">oncology@apollohospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Pioneering Cancer Technology</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>JCI Accredited Standards</span>
                  </div>
                </div>
              </div>
            </div>
...
export default ApolloOncoService;
