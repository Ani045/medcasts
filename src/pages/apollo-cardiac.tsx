  ...
  const doctors = [
    {
      ...
      expertise: ["Interventional Cardiology", "Complex Angioplasty", "Cardiac Imaging"]
    },
    {
      ...
      expertise: ["Coronary Interventions", "Structural Heart Disease", "Peripheral Interventions"]
    },
    {
      ...
      expertise: ["CABG Surgery", "Valve Surgery", "Minimally Invasive Surgery"]
    },
    {
    ...
    {
      name: "Dr. Ashok Seth",
      specialization: "Chairman - Cardiology",
      experience: "35+ years",
      patientsTreated: "8,500+",
      rating: "4.9",
      reviews: "485",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD, FRCP, FSCAI",
      expertise: ["Complex Interventions", "Cardiac Research", "Medical Leadership"]
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Excellence in Cardiac Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  India's premier healthcare destination with world-class cardiac specialists, advanced technology, and comprehensive heart care services.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Leading Cardiac Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">World-Class Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">State-of-Art Equipment</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">👨‍⚕️</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Expert Specialists</div>
                  <div className="text-xs text-gray-600">World-Class Team</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Sarita Vihar Metro Station</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.123456789!2d77.2923456!3d28.5123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce4aaaaaaab%3A0x404085140375fa29!2sApollo%20Hospital%20Delhi!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo Hospitals is Asia's foremost integrated healthcare services provider with a robust presence across the healthcare ecosystem. Our Heart Institute is equipped with cutting-edge technology and advanced cardiac catheterization labs.
                </p>
                <p>
                  Our team of highly skilled cardiac specialists provides world-class treatment with international standards of care, advanced surgical techniques, and comprehensive cardiac rehabilitation programs.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac evaluation, advanced imaging studies, and personalized treatment planning with world-class facilities.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac rehabilitation, lifestyle counseling, and recovery programs with international standards.
                    </div>
                  )}
                </div>
              </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911126925858?text=Hi, I'd like to know more about ${treatment.name} at Apollo Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911126925858?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$4,600</div>
                  <div className="text-sm text-gray-500">Consultation from $70</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911126925858?text=Hi, I want to book an appointment for cardiac consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911126925858?text=Hi, I need a cost estimate for cardiac treatment at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-11-26925858</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">cardiac@apollohospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+911126925858', '_blank')}
                >
