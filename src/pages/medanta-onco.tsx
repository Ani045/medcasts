  ...
  const doctors = [
    {
      ...
      expertise: ["Breast Cancer", "Lung Cancer", "Targeted Therapy"]
    },
    {
    ...
    },
    {
      ...
      qualifications: "MBBS, MS Surgery, MCh Surgical Oncology",
      expertise: ["Breast Cancer", "Thyroid Cancer", "Endocrine Surgery"]
    },
    {
      name: "Dr. Atul Sharma",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Medanta's oncology team provided world-class treatment for my lung cancer. The surgical expertise and post-operative care were exceptional. The international patient services made everything seamless.",
    ...
    },
    {
      ...
      rating: 5,
      story: "The comprehensive breast cancer treatment at Medanta exceeded my expectations. Dr. Dabas and his team were incredibly supportive throughout my journey. The quality of care was outstanding.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Surender Kumar Dabas"
    },
    {
      name: "Ahmed Hassan",
      age: 55,
      ...
      rating: 5,
      story: "The precision radiation therapy at Medanta was remarkable. Dr. Kataria's expertise in IMRT technology made my treatment highly effective with minimal side effects. The facilities are world-class.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Vinod Raina's expertise in medical oncology was exceptional. The targeted therapy treatment at Medanta Hospital was personalized and effective. The medical team provided comprehensive support.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Atul Sharma's expertise in hemato-oncology saved my life. The blood cancer treatment and bone marrow transplant at Medanta were performed with utmost precision and care.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Atul Sharma"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Premier <span className="text-teal-600">Oncology Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Premier cancer care with cutting-edge technology, world-class surgical expertise, and comprehensive treatment protocols.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/medanta.png" 
                    alt="Medanta Hospital - Premier Oncology Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Premier Cancer Institute</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">World-class Oncologists</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Medanta Cancer Institute is a premier comprehensive cancer center offering world-class surgical, medical, and radiation oncology services with cutting-edge technology and personalized care.
                </p>
                <p>
                  Our internationally trained team of oncologists and cutting-edge technology provide personalized treatment plans with the highest success rates and comprehensive support throughout the treatment journey.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-treatment care, supportive services, and rehabilitation programs with world-class monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911244144444?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Premier cancer care with world-class expertise and cutting-edge technology</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Hospital bed (premium room)</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">World-renowned oncology specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911244144444?text=Hi, I'd like to book an appointment with ${doctor.name} for oncology consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244144444?text=Hi, I want to book an appointment for oncology consultation at Medanta Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244144444?text=Hi, I need a cost estimate for cancer treatment at Medanta Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>19+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-124-4144444</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">oncology@medanta.org</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Cutting-edge Oncology Technology</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default MedantaOncoService;