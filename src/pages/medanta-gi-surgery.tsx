...
const MedantaGISurgeryService = () => {
  ...
  const doctors = [
    {
      name: "Dr. Randhir Sud",
      specialization: "Chairman, Institute of Digestive & Hepatobiliary Sciences",
      experience: "35+ years",
      ...
      expertise: ["Advanced Endoscopy", "ERCP", "Hepatobiliary Disorders"]
    },
    {
      name: "Dr. Arvinder Singh Soin",
      specialization: "Chairman, Institute of Liver Transplantation & Regenerative Medicine",
      experience: "30+ years",
    ...
    },
    {
      ...
      specialization: "Director, GI Surgery & GI Oncology",
      experience: "25+ years",
      ...
      expertise: ["GI Oncology", "Minimally Invasive Surgery", "Colorectal Surgery"]
    },
    {
    ...
    },
    {
      ...
      expertise: ["Laparoscopic GI Surgery", "Hernia Surgery", "Colorectal Surgery"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with colorectal cancer that had spread to my liver, I researched treatment options worldwide. Medanta's reputation for liver surgery led me to Dr. Soin. The multidisciplinary approach was impressive.",
    ...
    },
    {
      ...
      rating: 5,
      story: "After struggling with obesity and type 2 diabetes for years, I decided to undergo bariatric surgery. I chose Medanta after thorough research and consultation with Dr. Anurag Tandon.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Anurag Tandon"
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with pancreatic cancer, I knew I needed the best possible care. After consultations in multiple countries, I chose Medanta for Dr. Rajesh Gupta's expertise in pancreatic surgery.",
    ...
    },
    {
      ...
      age: 56,
      country: "UK",
      treatment: "Laparoscopic Colorectal Surgery",
      rating: 5,
      story: "After being diagnosed with colorectal cancer, I was referred to Medanta by my oncologist in London. Dr. Priya Ramachandran performed laparoscopic surgery that resulted in minimal scarring.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Priya Ramachandran"
    },
    {
      name: "Robert Anderson",
      age: 68,
      country: "Canada",
      treatment: "ERCP for Bile Duct Stones",
      rating: 5,
      story: "I was diagnosed with bile duct stones and jaundice while traveling in India. After being referred to Medanta, Dr. Randhir Sud performed an ERCP procedure that successfully removed the stones.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Randhir Sud"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/medanta.png" 
                    alt="Medanta - The Medicity - GI Surgery Center of Excellence" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Medanta - The Medicity GI Surgery Center of Excellence offers world-class gastrointestinal surgical care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our Institute of Digestive & Hepatobiliary Sciences is equipped with the latest technology and staffed by internationally trained specialists who perform both routine and complex GI surgeries with excellent outcomes.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811123456?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919811123456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811123456?text=Hi, I want to book an appointment for GI surgery consultation at Medanta Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811123456?text=Hi, I need a cost estimate for GI surgery at Medanta Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>18+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $60/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-98111-23456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">gi.surgery@medanta.org</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+919811123456', '_blank')}
                >
                  Emergency: +91-98111-23456
                </button>
              </div>
...
export default MedantaGISurgeryService;
