...
const MedantaBMTService = () => {
  ...
  const doctors = [
    {
      name: "Dr. Satish Kaushik",
      specialization: "Director, BMT & Hematology",
      experience: "25+ years",
    ...
    },
    {
      ...
      qualifications: "MBBS, MD Immunology, Fellowship Transplant Immunology",
      expertise: ["HLA Typing", "Graft vs Host Disease", "Immunotherapy"]
    },
    {
      name: "Dr. Vivek Jain",
      ...
      expertise: ["CAR-T Cell Therapy", "Leukemia", "Lymphoma"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with multiple myeloma, I researched extensively and chose Medanta for my bone marrow transplant. Dr. Kaushik and his team provided exceptional care throughout my treatment journey.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Satish Kaushik"
    },
    {
      name: "Aisha Rahman",
      age: 7,
      ...
      rating: 5,
      story: "Our daughter was diagnosed with thalassemia major and needed a bone marrow transplant. Dr. Neha Rastogi's expertise in pediatric BMT was remarkable. The care gave our daughter a second chance at life.",
    ...
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with acute myeloid leukemia and needed a bone marrow transplant. Dr. Amit Rauthan recommended a haploidentical transplant using my brother's stem cells. The procedure was successful.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Amit Rauthan"
    },
    {
      name: "Olivia Wilson",
      age: 32,
      ...
      rating: 5,
      story: "After multiple relapses of lymphoma, I was recommended CAR-T cell therapy at Medanta. Dr. Vivek Jain's expertise in this cutting-edge treatment was impressive. I've been in remission since.",
    ...
    },
    {
      ...
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "Being diagnosed with myelodysplastic syndrome was devastating, but finding Medanta was a blessing. Dr. Kaushik's expertise in bone marrow transplantation made my treatment journey smoother.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Satish Kaushik"
    }
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Premier BMT facility with advanced stem cell therapies and comprehensive hematological care at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/medanta.png" 
                    alt="Medanta - The Medicity - BMT Center of Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Medanta - The Medicity</h3>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">3,200+ Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦠</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Sector 38, Gurugram</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.123456789!2d77.0712345!3d28.4212345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d229aaaaaaab%3A0x404085140375fa29!2sMedanta%20The%20Medicity!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Medanta - The Medicity BMT Center of Excellence offers premier BMT facility with advanced stem cell therapies and comprehensive hematological care at affordable costs with internationally trained specialists.
                </p>
                <p>
                  The BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 3,200 successful procedures and outcomes matching global benchmarks.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/918800789456?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/918800789456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$19,000</div>
                  <div className="text-sm text-gray-500">Consultation from $190</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800789456?text=Hi, I want to book an appointment for BMT consultation at Medanta Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800789456?text=Hi, I need a cost estimate for BMT at Medanta Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>13+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $950/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-88007-89456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">bmt.coordinator@medanta.org</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Sector 38, Gurugram</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+918800789456', '_blank')}
                >
                  Emergency: +91-88007-89456
                </button>
              </div>
...
export default MedantaBMTService;
