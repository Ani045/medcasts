  ...
  const doctors = [
    {
      ...
      specialization: "Hematologist & BMT Specialist",
      experience: "20+ years",
      ...
      expertise: ["Bone Marrow Transplantation", "Leukemia Treatment", "Stem Cell Therapy"]
    },
    {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with multiple myeloma, I chose Artemis Hospital for my bone marrow transplant. Dr. Bhargava and his team provided exceptional care throughout my treatment journey. The state-of-the-art BMT unit and personalized care made a significant difference.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Our daughter was diagnosed with severe aplastic anemia and needed a bone marrow transplant. Dr. Shweta Bansal's expertise in pediatric BMT was remarkable. The care, compassion, and medical excellence at Artemis Hospital gave our daughter a second chance at life.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Shweta Bansal"
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with acute myeloid leukemia and needed a bone marrow transplant. With no fully matched donor available, Dr. Vikram Mathur recommended a haploidentical transplant using my sister's stem cells. The procedure was successful, and I'm now cancer-free.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Vikram Mathur"
    },
    {
      name: "Emma Thompson",
      age: 29,
      ...
      rating: 5,
      story: "After multiple relapses of lymphoma, I was recommended CAR-T cell therapy at Artemis Hospital. Dr. Rajat Agarwal's expertise in this cutting-edge treatment was impressive. The procedure was successful, and I've been in remission since.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Rajat Agarwal"
    },
    {
      name: "Raj Patel",
      age: 52,
      ...
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "Being diagnosed with chronic myeloid leukemia was devastating, but finding Artemis Hospital was a blessing. Dr. Bhargava's expertise in bone marrow transplantation and the world-class facilities made my treatment journey smoother.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Rahul Bhargava"
    }
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/artemis.png" 
                    alt="Artemis Hospital - BMT Center of Excellence" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Artemis BMT Center of Excellence offers world-class bone marrow transplant facility with advanced stem cell therapies and comprehensive hematological care at affordable costs with internationally trained specialists.
                </p>
                <p>
                  Our BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 2,800 successful procedures and outcomes matching global benchmarks.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/918800456789?text=Hi, I'd like to know more about ${treatment.name} at Artemis Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800456789?text=Hi, I want to book an appointment for BMT consultation at Artemis Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800456789?text=Hi, I need a cost estimate for BMT at Artemis Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>10+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">bmt.coordinator@artemishospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
...
export default ArtemisBMTService;
