...
const SarvodayaGISurgeryService = () => {
  ...
  const doctors = [
    {
      ...
      specialization: "Director, GI Surgery & Minimal Access Surgery",
      experience: "25+ years",
      ...
      expertise: ["Laparoscopic Surgery", "Bariatric Surgery", "Hernia Surgery"]
    },
    {
      name: "Dr. Amit Jain",
      ...
      expertise: ["Hepatobiliary Surgery", "Pancreatic Surgery", "GI Oncology"]
    },
    {
      name: "Dr. Priya Verma",
      specialization: "Consultant, Bariatric & Metabolic Surgery",
      experience: "15+ years",
    ...
    {
      name: "Dr. Vivek Sood",
      specialization: "Consultant, Advanced Laparoscopic Surgery",
      experience: "14+ years",
      ...
      expertise: ["Advanced Laparoscopy", "Hernia Surgery", "GI Surgery"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After my colon cancer diagnosis, I researched treatment options globally and chose Sarvodaya Hospital for their expertise in laparoscopic colorectal surgery. Dr. Sanjay Gupta performed a minimally invasive procedure that resulted in minimal scarring and faster recovery.",
    ...
    },
    {
      ...
      age: 48,
      country: "Spain",
      treatment: "Bariatric Surgery - Sleeve Gastrectomy",
      rating: 5,
      story: "After struggling with obesity and type 2 diabetes for years, I decided to undergo bariatric surgery. I chose Sarvodaya Hospital after thorough research and consultation with Dr. Priya Verma, who specializes in bariatric procedures.",
    ...
    },
    {
      ...
      treatment: "Pancreatic Surgery for Pancreatic Cancer",
      rating: 5,
      story: "When I was diagnosed with pancreatic cancer, I knew I needed the best possible care. After consultations in multiple countries, I chose Sarvodaya Hospital for Dr. Amit Jain's expertise in pancreatic surgery.",
    ...
    },
    {
      ...
      age: 54,
      country: "Russia",
      treatment: "Laparoscopic Cholecystectomy for Gallstones",
      rating: 5,
      story: "I had been suffering from recurrent gallstone attacks for months. After researching international options for treatment, I chose Sarvodaya Hospital for their expertise in laparoscopic surgery and affordable costs.",
    ...
    },
    {
      ...
      rating: 5,
      story: "I had been suffering from a complex ventral hernia that had recurred after previous surgeries. After consulting with several surgeons in Australia, I was referred to Sarvodaya Hospital and Dr. Vivek Sood.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Vivek Sood"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  World-class gastrointestinal surgical care with cutting-edge technology and experienced specialists at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/sarvodaya.png" 
                    alt="Sarvodaya Hospital & Research Centre - GI Surgery Center of Excellence" 
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🫀</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Bariatric Surgery</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">40 minutes from Delhi Airport</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sarvodaya Hospital & Research Centre GI Surgery Center of Excellence offers world-class gastrointestinal surgical care with cutting-edge technology and experienced specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our GI Surgery department is equipped with the latest technology including advanced laparoscopic systems and staffed by experienced specialists who perform both routine and complex GI surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive GI evaluation, advanced imaging studies, and multidisciplinary treatment planning with experienced specialists.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced gastrointestinal surgical procedures including minimally invasive and complex surgeries with advanced technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-operative care, rehabilitation programs, and follow-up care with monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced GI surgery with cutting-edge technology and experienced team</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Experienced GI surgery specialists with proven expertise</p>
                </div>
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    ...
                    <div>
                      ...
                      <p>✓ 4.7/5 rating from 5,000+ patients</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $45</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for GI surgery consultation at Sarvodaya Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for GI surgery at Sarvodaya Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $45/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">gi.surgery@sarvodayahospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Experienced GI Surgery</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default SarvodayaGISurgeryService;
