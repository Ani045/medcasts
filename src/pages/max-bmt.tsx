...
const MaxBMTService = () => {
  ...
  const doctors = [
    ...
    {
      name: "Dr. Meenu Walia",
      specialization: "Senior Director, Medical Oncology & BMT",
      experience: "30+ years",
      ...
      expertise: ["Hematological Malignancies", "Stem Cell Transplantation", "Lymphoma Treatment"]
    },
    {
    ...
    },
    {
      ...
      specialization: "Senior Consultant, Pediatric Oncology & BMT",
      experience: "25+ years",
      patientsTreated: "2,700+",
      rating: "4.9",
      reviews: "310",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD Pediatrics, Fellowship Pediatric Oncology",
      expertise: ["Pediatric BMT", "Childhood Leukemia", "Solid Tumors in Children"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with multiple myeloma, I researched extensively and chose Max Hospital for my bone marrow transplant. Dr. Rahul Naithani and his team provided exceptional care throughout my treatment journey.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Rahul Naithani"
    },
    {
      name: "Sophia Chen",
      age: 8,
      ...
      rating: 5,
      story: "Our daughter was diagnosed with thalassemia major and needed a bone marrow transplant. Dr. Divya Bansal's expertise in pediatric BMT was remarkable. The care gave our daughter a second chance at life.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Divya Bansal"
    },
    {
      name: "Ahmed Al-Farsi",
      age: 42,
    ...
    },
    {
      ...
      rating: 5,
      story: "Our daughter was diagnosed with severe aplastic anemia and needed a stem cell transplant. Dr. Amita Mahajan recommended a cord blood transplant. The procedure was successful, and our daughter is now thriving.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Amita Mahajan"
    },
    {
      name: "Rajiv Mehta",
      age: 55,
      ...
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "Being diagnosed with myelodysplastic syndrome was devastating, but finding Max Hospital was a blessing. Dr. Meenu Walia's expertise in bone marrow transplantation made my treatment journey smoother.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/max.png" 
                    alt="Max Super Speciality Hospital - BMT Center of Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Max Super Speciality Hospital</h3>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">CAR-T Cell Therapy</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">2,800+ Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦠</div>
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">88% Success</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">20 minutes from Delhi Airport</div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Saket Metro Station nearby</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Saket, New Delhi</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.123456789!2d77.2167345!3d28.5212345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce26aaaaaaab%3A0x404085140375fa29!2sMax%20Super%20Speciality%20Hospital%20Saket!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Max Super Speciality Hospital BMT Center of Excellence offers advanced BMT facility with cutting-edge stem cell therapies and comprehensive hematological care at affordable costs with internationally trained specialists.
                </p>
                <p>
                  The BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 2,800 successful procedures and outcomes matching global benchmarks.
                </p>
              </div>
            </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive evaluation, HLA typing, donor matching, and pre-transplant conditioning with internationally trained specialists.
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/918800456789?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced BMT care with cutting-edge technology and international expertise</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/918800456789?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    ...
                    <div>
                      ...
                      <p>✓ 4.8/5 rating from 7,000+ patients</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $180</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800456789?text=Hi, I want to book an appointment for BMT consultation at Max Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800456789?text=Hi, I need a cost estimate for BMT at Max Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $900/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-88004-56789</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">bmt.saket@maxhealthcare.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Saket, New Delhi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+918800456789', '_blank')}
                >
                  Emergency: +91-88004-56789
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Premier BMT Center</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Advanced CAR-T Therapy</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
