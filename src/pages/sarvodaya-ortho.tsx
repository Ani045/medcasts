...
const SarvodayaOrthoService = () => {
  ...
  const doctors = [
    ...
    },
    {
      ...
      expertise: ["Spinal Fusion", "Disc Surgery", "Scoliosis Correction"]
    },
    {
      name: "Dr. Amit Verma",
    ...
    },
    {
      ...
      expertise: ["Knee Arthroscopy", "Hip Arthroscopy", "Minimally Invasive Surgery"]
    },
    {
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Dr. Rajesh Kumar performed my hip replacement at Sarvodaya Hospital with exceptional skill. The compassionate care and advanced facilities made my recovery smooth. The hospital's commitment to patient welfare is truly commendable.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Amit Verma's expertise in sports medicine helped me return to my athletic career. The minimally invasive approach and excellent rehabilitation program at Sarvodaya Hospital exceeded my expectations. I'm back to playing tennis professionally.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Priya Sharma performed complex spine surgery with remarkable precision. The state-of-the-art facilities and compassionate care at Sarvodaya Hospital made my treatment journey comfortable and successful. I'm completely pain-free now.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Sunita Rao performed arthroscopic knee surgery with minimal invasion. The advanced technology and excellent post-operative care at Sarvodaya Hospital ensured quick recovery. The staff's dedication to patient care is outstanding.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Vikram Gupta's expertise in pediatric orthopedics was exceptional for our son's spinal condition. The child-friendly environment at Sarvodaya Hospital and compassionate care team made the entire experience comfortable for our family.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Compassionate Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Comprehensive orthopedic care with advanced technology and compassionate service for all your musculoskeletal needs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="https://newoaks.s3.us-west-1.amazonaws.com/AutoDev/17785/5a5c6486-ac30-487f-ae9b-6f452f80d4c5.jpeg" 
                    alt="Sarvodaya Hospital - Advanced Orthopaedic Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Sarvodaya Hospital</h3>
                    <p className="text-sm opacity-90">Compassionate Healthcare</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">⚽ Sports Medicine</h4>
                        <p className="text-xs opacity-90">Athletic Recovery</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🔬 Advanced Tech</h4>
                        <p className="text-xs opacity-90">State-of-the-art</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Advanced Care</div>
                  <div className="text-xs text-gray-600">Modern Facilities</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">⚽</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Sports Medicine</div>
                  <div className="text-xs text-gray-600">Athletic Recovery</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🔬</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Advanced Tech</div>
                  <div className="text-xs text-gray-600">State-of-the-art</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Delhi Metro Connection</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Faridabad, Delhi NCR</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3510.7284879856106!2d77.33382582564366!3d28.367057175810817!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cdc86f2034ab9%3A0x6d7590f65ebfdcfc!2sSarvodaya%20Hospital%20Park%2C%20Sector%208%2C%20Faridabad%2C%20Haryana%20121006!5e0!3m2!1sen!2sin!4v1757066009312!5m2!1sen!2sin"
                      width="100%" 
                      height="250" 
                      style={{ border: 0 }}
                  ...
                  <div className="mt-3 text-center">
                    <a 
                      href="https://maps.google.com/?cid=7073477306652985273" 
                      target="_blank" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sarvodaya Hospital's Orthopaedics Department offers comprehensive care with state-of-the-art technology and a team of highly skilled specialists dedicated to treating all musculoskeletal conditions.
                </p>
                <p>
                  Our commitment to compassionate healthcare and advanced surgical techniques ensures optimal outcomes for patients seeking orthopedic treatment, from routine procedures to complex reconstructive surgeries.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911294142000?text=Hi, I'd like to know more about ${treatment.name} at Sarvodaya Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Detailed treatment planning</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• State-of-the-art operation theater</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911294142000?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Advanced orthopedic procedures require comprehensive travel insurance covering surgical procedures, personal accidents, and emergency medical evacuation.
                  </p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911294142000?text=Hi, I want to book an appointment for orthopedic consultation at Sarvodaya Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911294142000?text=Hi, I need a cost estimate for orthopedic treatment at Sarvodaya Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>5+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $200/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91 129 414 2000</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">ortho@sarvodayahospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Faridabad, Delhi NCR</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency orthopedic services with advanced trauma care and immediate response team
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+911294142000', '_blank')}
                >
                  Emergency: +91 129 414 2000
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Advanced Surgical Technology</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default SarvodayaOrthoService;
