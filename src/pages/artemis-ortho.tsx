...
const ArtemisOrthoService = () => {
  ...
  const doctors = [
    ...
    },
    {
      ...
      expertise: ["Spinal Fusion", "Disc Surgery", "Minimally Invasive Spine"]
    },
    {
      ...
      qualifications: "MBBS, MS Neurosurgery, Fellowship Spine",
    ...
    },
    {
      ...
      expertise: ["Pediatric Orthopedics", "Trauma Surgery", "Joint Replacement"]
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Orthopaedic Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced joint replacement, spine surgery, and sports medicine with robotic precision and compassionate care.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="https://newoaks.s3.us-west-1.amazonaws.com/AutoDev/17785/96ea7811-e17f-4bd0-8dc9-c95c7b0002c7.png" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Leading Orthopaedic Center</p>
                  </div>
                </div>
                ...
                <div className="grid grid-rows-2 gap-4">
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🏥 Premium Care</h4>
                        <p className="text-xs opacity-90">Luxury Recovery Suites</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Sector 51, Gurugram - Medical Hub</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Our Orthopaedics Department offers comprehensive care for all bone, joint, and musculoskeletal conditions. 
                  With state-of-the-art technology and experienced specialists, we provide both surgical and non-surgical 
                  treatments tailored to each patient's needs.
                </p>
                <p>
                  From complex joint replacements to minimally invasive procedures, our team ensures the highest standard 
                  of care with faster recovery times and optimal outcomes.
                </p>
              </div>
            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91 11 4211 1111</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">ortho@artemishospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Sector 51, Gurugram, Haryana</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency orthopedic services available with immediate response team
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+911142110000', '_blank')}
                >
