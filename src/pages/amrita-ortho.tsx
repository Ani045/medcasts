  ...
  const doctors = [
    {
      ...
      expertise: ["Hip Replacement", "Knee Replacement", "Minimally Invasive Surgery"]
    },
    {
      name: "Dr. Ravi Suman Reddy",
      ...
      qualifications: "MBBS, MS Ortho, MCh Neurosurgery",
      expertise: ["Spinal Deformity", "Disc Surgery", "Minimally Invasive Spine"]
    },
    {
      name: "Dr. Priya Nair",
      ...
      qualifications: "MBBS, MS Ortho, Fellowship Pediatric Orthopedics",
      expertise: ["Congenital Deformities", "Growth Disorders", "Pediatric Trauma"]
    },
    {
      name: "Dr. Ashok Kumar",
      specialization: "Arthroscopy Specialist",
      experience: "23+ years",
      ...
      expertise: ["Knee Arthroscopy", "Shoulder Surgery", "Sports Medicine"]
    },
    {
      name: "Dr. Maya Krishnan",
      specialization: "Holistic Orthopedic Surgeon",
      experience: "21+ years",
      patientsTreated: "2,900+",
      rating: "4.9",
      reviews: "174",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MS Ortho, Fellowship Holistic Medicine",
      expertise: ["Integrative Surgery", "Mind-Body Healing", "Traditional Medicine"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Dr. Sandeep Vaishya performed my hip replacement at Amrita Hospital with exceptional care. The minimally invasive approach reduced my recovery time significantly. The holistic care approach and spiritual environment at Amrita made my healing journey peaceful and effective.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Priya Nair corrected my daughter's spinal deformity with incredible skill and compassion. The pediatric team at Amrita Hospital made the entire experience comfortable for our family. The child-friendly environment and excellent post-operative care exceeded our expectations.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Ravi Suman Reddy performed complex spine surgery using minimally invasive techniques. The integration of modern medicine with traditional healing practices at Amrita Hospital provided a unique and effective treatment experience. I'm completely pain-free now.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Ravi Suman Reddy"
    },
    {
      ...
      rating: 5,
      story: "Dr. Ashok Kumar performed arthroscopic knee surgery with minimal invasion. The spiritual healing environment at Amrita Hospital complemented the medical treatment perfectly. The compassionate care and excellent facilities made my recovery smooth and comfortable.",
    ...
    },
    {
      ...
      age: 44,
      country: "Singapore",
      treatment: "Holistic Joint Treatment",
      rating: 5,
      story: "Dr. Maya Krishnan's integrative approach combining modern surgery with traditional healing was remarkable. The mind-body healing program at Amrita Hospital addressed not just my physical condition but my overall wellness. The results exceeded all expectations.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Maya Krishnan"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Holistic Healing</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Holistic orthopedic care combining advanced medical technology with compassionate healing and spiritual wellness.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/amrita.jpeg" 
                    alt="Amrita Hospital - Holistic Orthopaedic Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Holistic Healing Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🔬 Minimally Invasive</h4>
                        <p className="text-xs opacity-90">Advanced Techniques</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">👶 Pediatric Care</h4>
                        <p className="text-xs opacity-90">Child Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Holistic Care</div>
                  <div className="text-xs text-gray-600">Mind-Body Healing</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">👶</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Pediatric Care</div>
                  <div className="text-xs text-gray-600">Child Specialists</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🔬</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Minimally Invasive</div>
                  <div className="text-xs text-gray-600">Advanced Techniques</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Amrita Hospital's Orthopaedics Department combines cutting-edge medical technology with holistic healing approaches, offering comprehensive care for all age groups including specialized pediatric orthopedics.
                </p>
                <p>
                  Our unique approach integrates modern surgical techniques with traditional healing practices, providing patients with a complete mind-body healing experience in a spiritually nurturing environment.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Costs may vary based on individual case complexity and room category</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Holistic treatment planning</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Minimally invasive operation theater</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Holistic rehabilitation</li>
                    <li>• Follow-up consultations</li>
                    <li>• Medications & dressings</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/914842801234?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Holistic orthopedic procedures require comprehensive travel insurance covering advanced surgical procedures, personal accidents, and emergency medical evacuation.
                  </p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$3,800</div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/914842801234?text=Hi, I want to book an appointment for orthopedic consultation at Amrita Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/914842801234?text=Hi, I need a cost estimate for orthopedic treatment at Amrita Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $210/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">ortho@amrita.edu</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency orthopedic services with holistic care approach and immediate response team
                </p>
                <button 
...
export default AmritaOrthoService;
