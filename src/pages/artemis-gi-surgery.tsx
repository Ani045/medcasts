...
const ArtemisGISurgeryService = () => {
  ...
  const doctors = [
    {
      name: "Dr. Arun Prasad",
      specialization: "Senior Consultant, GI & Bariatric Surgery",
      experience: "25+ years",
      ...
      expertise: ["Bariatric Surgery", "Advanced Laparoscopic Surgery", "Gastrointestinal Oncology"]
    },
    {
      name: "Dr. Vivek Vij",
      specialization: "Director, Liver Transplant & GI Surgery",
      experience: "22+ years",
    ...
    },
    {
      ...
      expertise: ["Pancreatic Surgery", "Bile Duct Surgery", "Minimally Invasive HPB Surgery"]
    },
    {
      name: "Dr. Nikhil Talwar",
      ...
      expertise: ["Colorectal Cancer Surgery", "Inflammatory Bowel Disease", "Pelvic Floor Disorders"]
    },
    {
      name: "Dr. Deepti Sinha",
      specialization: "Consultant, GI Surgery & Endoscopy",
      experience: "14+ years",
      patientsTreated: "1,800+",
      rating: "4.7",
      reviews: "190",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MS, DNB, Fellowship in Advanced GI Endoscopy",
      expertise: ["Therapeutic Endoscopy", "ERCP", "Gastrointestinal Stenting"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After struggling with obesity for over 20 years and developing related health issues, I decided to pursue bariatric surgery. I researched extensively and chose Artemis Hospital for their expertise and cost-effectiveness. Dr. Arun Prasad and his team provided exceptional care.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Arun Prasad"
    },
    {
      name: "Sarah Williams",
      age: 64,
      ...
      rating: 5,
      story: "When I was diagnosed with colorectal cancer, I was devastated. After researching treatment options globally, I chose Artemis Hospital for their expertise in minimally invasive colorectal surgery and comprehensive cancer care.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Nikhil Talwar"
    },
    {
      name: "Ahmed Al-Farsi",
      age: 58,
      country: "Oman",
      treatment: "Liver Resection for Hepatocellular Carcinoma",
      rating: 5,
      story: "After being diagnosed with liver cancer, I was referred to Artemis Hospital by my doctor in Oman. Dr. Vivek Vij performed a complex liver resection with precision and expertise. The pre-operative planning using advanced imaging was exceptional.",
    ...
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with pancreatic cancer, I knew I needed the best possible care. After consulting with specialists in multiple countries, I chose Artemis Hospital for Dr. Amit Javed's expertise in pancreatic surgery.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Amit Javed"
    },
    {
      name: "John Peterson",
      age: 62,
      ...
      rating: 5,
      story: "I was on vacation in India when I experienced severe abdominal pain. I was diagnosed with bile duct stones and referred to Artemis Hospital for specialized treatment. Dr. Deepti Sinha performed an ERCP procedure that successfully removed the stones.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Deepti Sinha"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced gastrointestinal surgical care with minimally invasive techniques and comprehensive treatment for digestive system disorders.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/artemis.png" 
                    alt="Artemis Hospital - GI Surgery Center of Excellence" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Artemis GI Surgery Center of Excellence offers advanced gastrointestinal surgical care with minimally invasive techniques and comprehensive treatment for digestive system disorders.
                </p>
                <p>
                  Our GI surgery department specializes in both routine and complex procedures, with particular expertise in minimally invasive techniques that result in smaller incisions, less pain, and faster recovery times.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919810123456?text=Hi, I'd like to know more about ${treatment.name} at Artemis Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced GI surgery with minimally invasive techniques and international expertise</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919810123456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I want to book an appointment for GI surgery consultation at Artemis Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919810123456?text=Hi, I need a cost estimate for GI surgery at Artemis Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $75/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">gi.surgery@artemishospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
...
export default ArtemisGISurgeryService;
