  ...
  const doctors = [
    {
      ...
      expertise: ["Coronary Surgery", "Valve Surgery", "Minimally Invasive Cardiac Surgery"]
    },
    {
      name: "Dr. Suma Victor",
      ...
      expertise: ["Angioplasty", "Stenting", "Complex Interventions"]
    },
    {
      name: "Dr. Raman Krishna Kumar",
      ...
      expertise: ["Congenital Heart Disease", "Pediatric Surgery", "Neonatal Cardiac Surgery"]
    },
    {
      name: "Dr. K.M. Mandana",
      ...
      expertise: ["Arrhythmia Treatment", "Device Implantation", "Ablation Procedures"]
    },
    {
      ...
      expertise: ["Echocardiography", "Cardiac Imaging", "Preventive Cardiology"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Exceptional cardiac care at Amrita Hospital. The angioplasty procedure was performed with outstanding precision and the medical team was world-class. The holistic approach to healing made a significant difference in my recovery.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Suma Victor"
    },
    {
      name: "Lisa Thompson",
      age: 52,
      ...
      rating: 5,
      story: "Outstanding surgical expertise and comprehensive care at Amrita Hospital. The valve replacement surgery was excellent and recovery was smooth with exceptional support. The spiritual environment aided in my healing process.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Jose Chacko Periappuram"
    },
    {
      ...
      rating: 5,
      story: "World-class cardiac surgery center with exceptional facilities. The CABG procedure was performed with great expertise and outstanding post-operative care. The compassionate approach at Amrita Hospital exceeded all expectations.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Dr. Raman Krishna Kumar performed life-saving congenital heart surgery on my daughter with incredible skill. The pediatric cardiac team at Amrita Hospital provided exceptional care with compassion and expertise throughout our journey.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Raman Krishna Kumar"
    },
    {
      name: "Robert Chen",
      age: 65,
      ...
      rating: 5,
      story: "Dr. K.M. Mandana's expertise in cardiac electrophysiology was remarkable. The pacemaker implantation was performed flawlessly and the holistic care approach at Amrita Hospital made my recovery comfortable and complete.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. K.M. Mandana"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Compassionate Cardiac Care</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Leading cardiac care with advanced medical technology, holistic healing approaches, and dedicated heart specialists.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/amrita.jpeg" 
                    alt="Amrita Hospital - Compassionate Cardiac Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Comprehensive Cardiac Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">Precision Care</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🕉️ Holistic Care</h4>
                        <p className="text-xs opacity-90">Mind-Body Healing</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">Expert Heart Care</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🕉️</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Holistic Approach</div>
                  <div className="text-xs text-gray-600">Complete Healing</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">45 minutes from Kochi Airport</div>
                      <div className="text-sm text-gray-600">Cochin International Airport - Direct connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Kochi Metro Connection</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.123456789!2d76.2923456!3d10.0123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d26aaaaaaab%3A0x404085140375fa29!2sAmrita%20Hospital%20Kochi!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Amrita Hospital's Institute of Cardiovascular Sciences combines cutting-edge medical technology with holistic healing approaches, offering comprehensive cardiac care for all heart conditions.
                </p>
                <p>
                  Our dedicated team of cardiologists and cardiac surgeons provide world-class treatment with advanced cardiac catheterization labs, state-of-the-art equipment, and compassionate care in a spiritually nurturing environment.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac evaluation, advanced imaging studies, and personalized treatment planning with holistic assessment.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced cardiac procedures including angioplasty, bypass surgery, valve repairs, and minimally invasive interventions.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac rehabilitation, lifestyle counseling, and holistic recovery programs with spiritual support.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/914842801234?text=Hi, I'd like to know more about ${treatment.name} at Amrita Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Costs may vary based on individual case complexity and procedure requirements</li>
                  <li>• Prices include surgeon fees, hospital charges, and basic medications</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Spiritual healing support</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">World-class cardiac specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/914842801234?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/914842801234?text=Hi, I want to book an appointment for cardiac consultation at Amrita Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/914842801234?text=Hi, I need a cost estimate for cardiac treatment at Amrita Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91 484 280 1234</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">cardiac@amrita.edu</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency cardiac services with immediate response team and advanced cardiac life support
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+914842801234', '_blank')}
                >
                  Emergency: +91 484 280 1234
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Holistic Cardiac Care</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default AmritaCardiacService;