...
const AmritaBMTService = () => {
  ...
  const treatments = [
    ...
    },
    {
      name: "Immunotherapy",
      cost: "$15,000 - $25,000",
      description: "Treatment that uses the body's immune system to fight diseases like cancer and blood disorders",
      duration: "2-3 weeks",
      stay: "3-4 weeks"
    }
  ];
  ...
  const doctors = [
    {
      name: "Dr. Neeraj Sidharthan",
      specialization: "Head, Bone Marrow Transplant Unit",
      experience: "22+ years",
      patientsTreated: "1,800+",
      rating: "4.9",
      reviews: "280",
      image: "/dr-dr-rajiv-yadav.jpg",
      qualifications: "MBBS, MD, DM Clinical Hematology, Fellowship BMT (UK)",
      expertise: ["Bone Marrow Transplantation", "Hematological Malignancies", "Hemato-Oncology"]
    },
    {
      name: "Dr. Vineetha Raghavan",
      specialization: "Senior Consultant, Hematology",
      experience: "18+ years",
      patientsTreated: "1,500+",
      rating: "4.8",
      reviews: "220",
      image: "/dr-vandana.jpeg",
      qualifications: "MBBS, MD, DM Clinical Hematology",
      expertise: ["Leukemia Treatment", "Lymphoma Management", "Bone Marrow Failure Syndromes"]
    },
    {
      name: "Dr. Anu Korula",
      specialization: "Associate Professor, Clinical Hematology",
      experience: "15+ years",
      ...
      qualifications: "MBBS, MD, DM Clinical Hematology",
      expertise: ["Allogeneic Transplants", "Haploidentical Transplants", "Graft-versus-Host Disease Management"]
    },
    {
      name: "Dr. Aby Abraham",
      specialization: "Professor, Clinical Hematology",
      experience: "20+ years",
      patientsTreated: "1,600+",
      rating: "4.9",
      reviews: "250",
      image: "/dr-dr-i-p-s-oberoi.jpg",
      qualifications: "MBBS, MD, DM Clinical Hematology, Fellowship in BMT",
      expertise: ["Thalassemia Management", "Sickle Cell Disease", "Pediatric BMT"]
    },
    {
      name: "Dr. Fouzia NA",
      specialization: "Associate Professor, Clinical Hematology",
      experience: "14+ years",
      patientsTreated: "1,100+",
      rating: "4.7",
      reviews: "180",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD, DM Clinical Hematology",
      expertise: ["Multiple Myeloma", "Aplastic Anemia", "Myelodysplastic Syndromes"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "After being diagnosed with acute myeloid leukemia, I researched extensively for treatment options. Amrita Hospital's BMT unit came highly recommended. Dr. Neeraj Sidharthan and his team provided exceptional care throughout my treatment journey.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Neeraj Sidharthan"
    },
    {
      name: "Aisha Rahman",
      age: 7,
      ...
      rating: 5,
      story: "Our daughter was diagnosed with thalassemia major and needed a bone marrow transplant. Dr. Aby Abraham recommended a haploidentical transplant using my cells. The procedure was successful, and our daughter is now thriving.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Aby Abraham"
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with multiple myeloma and needed a bone marrow transplant. Dr. Fouzia NA recommended an autologous transplant using my own stem cells. The procedure was successful, and I'm now in remission.",
    ...
    },
    {
      ...
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "After being diagnosed with chronic myeloid leukemia, I needed a bone marrow transplant. Dr. Vineetha Raghavan and her team at Amrita Hospital provided exceptional care throughout my treatment journey.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Vineetha Raghavan"
    },
    {
      name: "Rajiv Patel",
      age: 12,
      ...
      rating: 5,
      story: "Our son was diagnosed with severe aplastic anemia and needed a stem cell transplant. Dr. Anu Korula recommended a cord blood transplant. The procedure was successful, and our son is now thriving.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Anu Korula"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                ...
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Internationally recognized BMT center with advanced stem cell therapies and comprehensive hematological care at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/amrita.png" 
                    alt="Amrita Hospital - BMT Center of Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Amrita Hospital</h3>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">1,500+ Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🩺</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Immunotherapy</div>
                  <div className="text-xs text-gray-600">Advanced Treatment</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">85% Success</div>
                  <div className="text-xs text-gray-600">Proven Results</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">NABH Accredited</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">30 minutes from Cochin Airport</div>
                      <div className="text-sm text-gray-600">COK Airport (Cochin) - Direct connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Kochi Metro</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Ponekkara, Kochi, Kerala</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3928.123456789!2d76.3123456!3d10.0123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d26aaaaaaab%3A0x404085140375fa29!2sAmrita%20Institute%20of%20Medical%20Sciences!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Amrita BMT Center of Excellence offers internationally recognized bone marrow transplant facility with advanced stem cell therapies and comprehensive hematological care at affordable costs with dedicated specialists.
                </p>
                <p>
                  Our BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 1,500 successful procedures and outcomes matching international benchmarks.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive evaluation, HLA typing, donor matching, and pre-transplant conditioning with internationally recognized expertise.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced bone marrow transplant procedures including autologous, allogeneic, and immunotherapy with cutting-edge technology.
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919846123456?text=Hi, I'd like to know more about ${treatment.name} at Amrita Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Internationally recognized BMT care with advanced stem cell therapies and expert specialists</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919846123456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  <h3 className="font-bold text-blue-800 mb-3">Why Choose MedCasts with Amrita</h3>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $100</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846123456?text=Hi, I want to book an appointment for BMT consultation at Amrita Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919846123456?text=Hi, I need a cost estimate for BMT at Amrita Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>6+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $750/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-98461-23456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">bmt@aims.amrita.edu</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Ponekkara, Kochi, Kerala</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+919846123456', '_blank')}
                >
                  Emergency: +91-98461-23456
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Internationally Recognized BMT</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default AmritaBMTService;
