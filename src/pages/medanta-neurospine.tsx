...
const MedantaNeuroSpineService = () => {
  ...
  const doctors = [
    ...
    {
      name: "Dr. Gaurav Goel",
      specialization: "Director, Neuro-intervention",
      experience: "18+ years",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with a complex meningioma, I sought second opinions and discovered Dr. Sandeep Vaishya at Medanta. The surgery was successful with complete tumor removal and no neurological deficits.",
    ...
    },
    {
      ...
      rating: 5,
      story: "After living with Parkinson's disease for 15 years, my neurologist suggested Deep Brain Stimulation and recommended Dr. Sudhir Dubey at Medanta. The improvement in my symptoms has been remarkable.",
    ...
    },
    {
      ...
      rating: 5,
      story: "I was diagnosed with a brain aneurysm during a routine MRI for headaches. Dr. Gaurav Goel performed coiling of my aneurysm through a small incision in my groin - no open brain surgery needed!",
    ...
    },
    {
      ...
      rating: 5,
      story: "I had been suffering from severe neck pain and arm weakness due to cervical disc herniation. Dr. Vidhu Bhatnagar recommended artificial disc replacement instead of fusion to maintain motion.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/medanta.png" 
                    alt="Medanta - The Medicity - Institute of Neurosciences" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Medanta - The Medicity Institute of Neurosciences offers world-class neurosurgical and spine care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Medanta Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for neurospine consultation at Medanta Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for neurospine surgery at Medanta Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $375/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">neurospine@medanta.org</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
...
export default MedantaNeuroSpineService;
