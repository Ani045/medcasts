          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Affordable <span className="text-teal-600">Cancer Care Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Comprehensive cancer care with advanced surgical techniques, precision radiation therapy, and personalized treatment protocols at affordable prices.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Affordable Cancer Center</p>
                  </div>
                </div>
                ...
                <div className="grid grid-rows-2 gap-4">
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🏥 Comprehensive Care</h4>
                        <p className="text-xs opacity-90">Multidisciplinary Team</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Artemis Oncology Department is a state-of-the-art comprehensive cancer center offering advanced surgical, medical, and radiation oncology services at the most affordable prices.
                </p>
                <p>
                  Our multidisciplinary team of oncologists, surgeons, and support staff provide personalized treatment plans using the latest technology and evidence-based protocols with exceptional affordability.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cancer staging, advanced imaging studies, and multidisciplinary treatment planning with affordable consultation fees.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced surgical procedures, chemotherapy, radiation therapy, and targeted treatments with cost-effective protocols.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-treatment care, supportive services, and rehabilitation programs with affordable follow-up care.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Most affordable cancer care in India with international quality</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911244511111?text=Hi, I'd like to book an appointment with ${doctor.name} for oncology consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    <li>• Patients must arrive at least 1 day before treatment for pre-assessment</li>
                ...
                <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    ...
                    <p>• For treatments beyond 30 days, 25% advance payment to confirm booking</p>
                    <p>• Cancellations 15+ days before treatment: 80% refund (excluding booking fee)</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$2,800</div>
                  <div className="text-sm text-gray-500">Consultation from $40</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244511111?text=Hi, I want to book an appointment for oncology consultation at Artemis Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911244511111?text=Hi, I need a cost estimate for cancer treatment at Artemis Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $160/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">oncology@artemishospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
