...
const ApolloBMTService = () => {
  ...
  const treatments = [
    {
      ...
      cost: "$20,000 - $28,000",
      description: "Procedure using patient's own stem cells to restore blood-forming cells after high-dose chemotherapy",
      duration: "3-4 weeks",
      stay: "4-6 weeks"
    },
    {
      ...
      cost: "$35,000 - $50,000",
      description: "Transplantation of stem cells from a matched donor to replace diseased bone marrow",
      duration: "4-6 weeks",
      stay: "6-8 weeks"
    },
    {
      ...
      cost: "$32,000 - $45,000",
      description: "Specialized transplant using partially matched donor cells, typically from a family member",
      duration: "4-5 weeks",
      stay: "6-8 weeks"
    },
    {
      name: "Peripheral Blood Stem Cell Transplant",
      cost: "$24,000 - $35,000",
      description: "Collection and transplantation of stem cells from peripheral blood instead of bone marrow",
      duration: "3-4 weeks",
      stay: "4-6 weeks"
    },
    {
      ...
      cost: "$30,000 - $42,000",
      description: "Transplantation using stem cells collected from umbilical cord blood",
      duration: "3-4 weeks",
      stay: "5-7 weeks"
    },
    {
      ...
      cost: "$48,000 - $70,000",
      description: "Advanced cellular therapy where T cells are modified to target and destroy cancer cells",
      duration: "2-3 weeks",
      stay: "3-4 weeks"
    },
    {
      ...
      cost: "$6,000 - $9,000",
      description: "Procedure to collect stem cells from bone marrow or peripheral blood for transplantation",
      duration: "1-2 days",
      stay: "1-2 days"
    },
    {
      name: "HLA Typing",
      cost: "$2,000 - $3,500",
      description: "Genetic testing to determine compatibility between donor and recipient for transplantation",
      duration: "1-2 days",
      stay: "Outpatient"
    }
  ];
  ...
  const doctors = [
    {
      name: "Dr. Anupam Verma",
      specialization: "Senior Consultant, Hematology & BMT",
      experience: "28+ years",
      patientsTreated: "3,500+",
      rating: "4.9",
      reviews: "380",
      image: "/dr-dr-rajiv-yadav.jpg",
      qualifications: "MBBS, MD, DM Clinical Hematology, Fellowship BMT (USA)",
      expertise: ["Bone Marrow Transplantation", "Leukemia Treatment", "Hematological Malignancies"]
    },
    {
      name: "Dr. Sangeeta Pathak",
      specialization: "Director, Pediatric Hematology & BMT",
      experience: "22+ years",
      patientsTreated: "2,800+",
      rating: "4.8",
      reviews: "320",
      image: "/dr-vandana.jpeg",
      qualifications: "MBBS, MD Pediatrics, DM Hematology-Oncology",
      expertise: ["Pediatric BMT", "Thalassemia Management", "Immunodeficiency Disorders"]
    },
    {
      name: "Dr. Rahul Bhargava",
      specialization: "Director, Hematology & BMT",
      experience: "25+ years",
      patientsTreated: "3,200+",
      rating: "4.9",
      reviews: "365",
      image: "/dr-dr-aditya-gupta.jpg",
      qualifications: "MBBS, MD, DM Clinical Hematology, Fellowship BMT",
      expertise: ["Allogeneic Transplants", "Multiple Myeloma", "Lymphoma Treatment"]
    },
    {
      name: "Dr. Nita Radhakrishnan",
      specialization: "Associate Director, Pediatric Hematology",
      experience: "18+ years",
      patientsTreated: "2,200+",
      rating: "4.7",
      reviews: "280",
      image: "/dr-dr-i-p-s-oberoi.jpg",
      qualifications: "MBBS, MD Pediatrics, DM Hematology",
      expertise: ["Pediatric BMT", "Hemoglobinopathies", "Bone Marrow Failure Syndromes"]
    },
    {
      name: "Dr. Gaurav Kharya",
      specialization: "Senior Consultant, BMT & Cellular Therapy",
      experience: "20+ years",
      patientsTreated: "2,500+",
      rating: "4.8",
      reviews: "310",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD, DM Hematology, Fellowship Cellular Therapy",
      expertise: ["CAR-T Cell Therapy", "Haploidentical Transplants", "Pediatric BMT"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      age: 52,
      country: "Canada",
      treatment: "Allogeneic Bone Marrow Transplant",
      rating: 5,
      story: "After being diagnosed with acute myeloid leukemia, I researched extensively and chose Apollo Hospital for my bone marrow transplant. Dr. Anupam Verma and his team provided exceptional care throughout my treatment journey.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Anupam Verma"
    },
    {
      name: "Fatima Al-Sayed",
      age: 9,
      country: "UAE",
      treatment: "Haploidentical Transplant",
      rating: 5,
      story: "Our daughter was diagnosed with thalassemia major and needed a bone marrow transplant. Dr. Sangeeta Pathak's expertise in pediatric BMT was remarkable. The care, compassion, and medical excellence at Apollo gave our daughter a second chance at life.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Sangeeta Pathak"
    },
    {
      name: "David Williams",
      age: 45,
      country: "UK",
      treatment: "Autologous Bone Marrow Transplant",
      rating: 5,
      story: "I was diagnosed with multiple myeloma and needed a bone marrow transplant. Dr. Rahul Bhargava recommended an autologous transplant using my own stem cells. The procedure was successful, and I'm now cancer-free.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Rahul Bhargava"
    },
    {
      name: "Sarah Thompson",
      age: 12,
      country: "Australia",
      treatment: "Cord Blood Transplant",
      rating: 5,
      story: "Our daughter was diagnosed with severe aplastic anemia and needed a stem cell transplant. Dr. Nita Radhakrishnan recommended a cord blood transplant. The procedure was successful, and our daughter is now thriving.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Nita Radhakrishnan"
    },
    {
      name: "Ibrahim Khalid",
      age: 35,
      ...
      rating: 5,
      story: "After multiple relapses of lymphoma, I was recommended CAR-T cell therapy at Apollo Hospital. Dr. Gaurav Kharya's expertise in this cutting-edge treatment was impressive. The procedure was successful, and I've been in remission since.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Gaurav Kharya"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-teal-600 font-medium">BMT</span>
              </div>
              
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  BMT Center of <span className="text-teal-600">Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  World-class BMT facility with advanced stem cell therapies and comprehensive hematological care at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/apollo.png" 
                    alt="Apollo Hospital - BMT Center of Excellence" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Apollo Hospital</h3>
                    <p className="text-sm opacity-90">BMT Center of Excellence</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">Stem Cell Therapy</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="World-Class BMT Specialists" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">BMT Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">BMT Excellence</div>
                  <div className="text-xs text-gray-600">3,500+ Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦠</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">CAR-T Therapy</div>
                  <div className="text-xs text-gray-600">Advanced Treatment</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">90% Success</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">15 minutes from Delhi Airport</div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Sarita Vihar Metro</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Sarita Vihar, New Delhi</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3508.123456789!2d77.2923456!3d28.5223456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce26aaaaaaab%3A0x404085140375fa29!2sApollo%20Hospitals%20Delhi!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo BMT Center of Excellence offers world-class bone marrow transplant facility with advanced stem cell therapies and comprehensive hematological care at affordable costs with internationally trained specialists.
                </p>
                <p>
                  Our BMT unit features HEPA-filtered rooms, state-of-the-art monitoring systems, and a specialized team trained in managing transplant patients with over 3,500 successful procedures and outcomes matching global benchmarks.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span className="font-semibold text-lg">Pre-transplant Evaluation</span>
                    </div>
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive evaluation, HLA typing, donor matching, and pre-transplant conditioning with world-class expertise.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">BMT Procedure</span>
                    </div>
                    {expandedSection === 'treatment' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced bone marrow transplant procedures including autologous, allogeneic, and CAR-T cell therapy with cutting-edge technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">Post-transplant Care</span>
                    </div>
                    {expandedSection === 'recovery' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-transplant monitoring, infection prevention, and long-term follow-up care with advanced monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/918800123456?text=Hi, I'd like to know more about ${treatment.name} at Apollo Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• World-class BMT care with advanced stem cell therapies and international expertise</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  <div className="flex items-center mb-3">
                    ...
                    <span className="font-bold text-teal-800">Pre-transplant Care</span>
                  </div>
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Comprehensive evaluation</li>
                    <li>• HLA typing & donor matching</li>
                    <li>• Pre-conditioning therapy</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  <div className="flex items-center mb-3">
                    <CheckCircle className="w-5 h-5 text-teal-500 mr-2" />
                    <span className="font-bold text-teal-800">Transplant & Hospital Stay</span>
                  </div>
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• BMT procedure</li>
                    <li>• Specialist fees</li>
                    <li>• HEPA-filtered isolation room</li>
                    <li>• 24/7 intensive monitoring</li>
                  </ul>
                </div>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  <div className="flex items-center mb-3">
                    <CheckCircle className="w-5 h-5 text-teal-500 mr-2" />
                    <span className="font-bold text-teal-800">Post-transplant Care</span>
                  </div>
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Recovery monitoring</li>
                    <li>• Infection prevention</li>
                    <li>• Medications & support</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Internationally trained BMT specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/918800123456?text=Hi, I'd like to book an appointment with ${doctor.name} for BMT consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    BMT procedures require comprehensive travel insurance covering transplant complications, extended hospitalization, and emergency medical evacuation.
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    <li>• Patients must arrive at least 1 week before transplant for pre-conditioning</li>
                    <li>• Bring all medical records, previous treatment history, and donor information</li>
                    <li>• International patients require valid passport and medical visa</li>
                    <li>• Family member/caregiver must accompany patient throughout treatment</li>
                    <li>• Plan for 2-3 months stay in India for complete treatment and recovery</li>
                  </ul>
                </div>
                ...
                <div className="bg-amber-50 rounded-xl p-5 border border-amber-200">
                  ...
                  <div className="text-amber-700 text-sm space-y-2">
                    <p>• For BMT scheduled within 30 days, full payment is required</p>
                    <p>• For BMT beyond 30 days, 50% advance payment to confirm booking</p>
                    <p>• Cancellations 15+ days before treatment: 50% refund (excluding booking fee)</p>
                    <p>• Cancellations within 14 days: Non-refundable</p>
                    <p>• Medical emergencies and complications considered case-by-case</p>
                  </div>
                </div>

                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  <h3 className="font-bold text-blue-800 mb-3">Why Choose MedCasts with Apollo</h3>
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    ...
                    <div>
                      ...
                      <p>✓ 4.9/5 rating from 5,000+ patients</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $150</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800123456?text=Hi, I want to book an appointment for BMT consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/918800123456?text=Hi, I need a cost estimate for BMT at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>8+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $1,000/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-88001-23456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">bmt.delhi@apollohospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Sarita Vihar, New Delhi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency BMT services with immediate response team and comprehensive transplant care
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+918800123456', '_blank')}
                >
                  Emergency: +91-88001-23456
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>World-Class BMT Center</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Expert BMT Specialists</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default ApolloBMTService;
