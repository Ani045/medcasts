  ...
  const doctors = [
    {
      ...
      specialization: "Chairman, Max Institute of Minimal Access, Metabolic & Bariatric Surgery",
      experience: "35+ years",
    ...
    },
    {
      ...
      specialization: "Director, Liver Transplant & HPB Surgery",
      experience: "20+ years",
      patientsTreated: "3,500+",
      rating: "4.8",
      reviews: "260",
      image: "/dr-vandana.jpeg",
      qualifications: "MBBS, MS, Fellowship in HPB Surgery & Liver Transplantation",
      expertise: ["Liver Transplantation", "Hepatobiliary Surgery", "Pancreatic Surgery"]
    },
    {
      name: "Dr. Rudra Prasad Doley",
      ...
      expertise: ["GI Oncology", "Pancreatic Surgery", "Minimally Invasive Surgery"]
    },
    {
    ...
    },
    {
      ...
      qualifications: "MBBS, MS, Fellowship in Colorectal Surgery (UK)",
  ...
  const testimonials = [
    {
      ...
      age: 54,
      country: "USA",
      treatment: "Robotic Colorectal Surgery for Rectal Cancer",
      rating: 5,
      story: "After my rectal cancer diagnosis, I researched treatment options globally and chose Max Hospital Delhi for their expertise in robotic colorectal surgery. Dr. Samit Jain performed a robotic procedure that resulted in minimal scarring and faster recovery.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Samit Jain"
    },
    {
      name: "Sarah Johnson",
      age: 42,
      ...
      rating: 5,
      story: "After struggling with obesity and type 2 diabetes for years, I decided to undergo bariatric surgery. I chose Max Hospital after thorough research and consultation with Dr. Pradeep Chowbey, a pioneer in laparoscopic surgery.",
    ...
    },
    {
      ...
      rating: 5,
      story: "When I was diagnosed with pancreatic cancer, I knew I needed the best possible care. After consultations in multiple countries, I chose Max Hospital for Dr. Rudra Prasad Doley's expertise in pancreatic surgery.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Rudra Prasad Doley"
    },
    {
      name: "Elena Petrova",
      age: 58,
      ...
      rating: 5,
      story: "After being diagnosed with colorectal cancer that had spread to my liver, I researched treatment options worldwide. Max Hospital's reputation for liver surgery led me to Dr. Vivek Mangla.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Vivek Mangla"
    },
    {
      name: "Michael Brown",
      age: 48,
      ...
      rating: 5,
      story: "I had been suffering from a complex ventral hernia that had recurred after previous surgeries. After consulting with several surgeons in Australia, I was referred to Max Hospital and Dr. Pradeep Chowbey.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/max.png" 
                    alt="Max Super Speciality Hospital - GI Surgery Center of Excellence" 
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🫀</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Liver Surgery</div>
                  <div className="text-xs text-gray-600">Advanced Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">99% Success</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Saket Metro Station</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.123456789!2d77.2112345!3d28.5212345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce26aaaaaaab%3A0x404085140375fa29!2sMax%20Super%20Speciality%20Hospital%20Saket!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Max Super Speciality Hospital GI Surgery Center of Excellence offers world-class gastrointestinal surgical care with cutting-edge technology and internationally trained specialists providing comprehensive treatment at affordable costs.
                </p>
                <p>
                  Our Institute of Minimal Access, Metabolic & Bariatric Surgery is equipped with the latest technology including robotic surgical systems and staffed by internationally trained specialists who perform both routine and complex GI surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced gastrointestinal surgical procedures including minimally invasive, robotic, and complex surgeries with cutting-edge technology.
                    </div>
                  )}
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811789456?text=Hi, I'd like to know more about ${treatment.name} at Max Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced GI surgery with cutting-edge technology and international expertise</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919811789456?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$1,100</div>
                  <div className="text-sm text-gray-500">Consultation from $55</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811789456?text=Hi, I want to book an appointment for GI surgery consultation at Max Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811789456?text=Hi, I need a cost estimate for GI surgery at Max Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>16+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $55/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91-98117-89456</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">gi.surgery@maxhealthcare.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <button 
                  ...
                  onClick={() => window.open('tel:+919811789456', '_blank')}
                >
                  Emergency: +91-98117-89456
                </button>
              </div>
...
export default MaxGISurgeryService;
