  ...
  const treatments = [
    {
      ...
      cost: "$2,800 - $4,200",
      description: "Minimally invasive removal of the gallbladder using small incisions and a camera",
      duration: "1-2 hours",
      stay: "1-2 days"
    },
    {
      ...
      cost: "$5,800 - $10,500",
      description: "Weight loss procedures including gastric bypass, sleeve gastrectomy, and gastric banding",
      duration: "2-3 hours",
      stay: "3-5 days"
    },
    {
      ...
      cost: "$5,000 - $9,000",
      description: "Surgical treatment for conditions affecting the colon, rectum, and anus",
      duration: "2-4 hours",
      stay: "5-7 days"
    },
    {
      name: "Hernia Repair",
      cost: "$2,500 - $5,000",
      description: "Correction of weaknesses in the abdominal wall using mesh reinforcement",
      duration: "1-2 hours",
      stay: "1-3 days"
    },
    {
      ...
      cost: "$12,000 - $22,000",
      description: "Surgical removal of portions of the liver affected by tumors or disease",
      duration: "3-5 hours",
      stay: "7-10 days"
    },
    {
      ...
      cost: "$15,000 - $25,000",
      description: "Complex procedures for pancreatic cancer, pancreatitis, and other pancreatic disorders",
      duration: "4-6 hours",
      stay: "10-14 days"
    },
    {
      ...
      cost: "$1,000 - $2,500",
      description: "Minimally invasive diagnostic and therapeutic procedures using flexible scopes",
    ...
    },
    {
      name: "Gastrectomy",
      cost: "$8,500 - $15,000",
      description: "Partial or complete removal of the stomach for cancer or severe ulcers",
      duration: "3-5 hours",
      stay: "7-10 days"
    }
  ];
  ...
  const doctors = [
    {
      ...
      specialization: "Senior Consultant, GI Surgery & Liver Transplantation",
      experience: "30+ years",
      patientsTreated: "8,000+",
      rating: "4.9",
      reviews: "320",
      image: "/dr-dr-rajiv-yadav.jpg",
      qualifications: "MBBS, MS, Fellowship in Liver Transplantation (Australia)",
      expertise: ["Liver Transplantation", "Hepatobiliary Surgery", "Pancreatic Surgery"]
    },
    {
      name: "Dr. Venkatesh Munikrishnan",
      specialization: "Senior Consultant, Colorectal Surgery",
      experience: "25+ years",
      patientsTreated: "6,500+",
      rating: "4.8",
      reviews: "280",
      image: "/dr-vandana.jpeg",
      qualifications: "MBBS, MS, FRCS (UK), Fellowship in Colorectal Surgery",
      expertise: ["Colorectal Cancer Surgery", "Inflammatory Bowel Disease", "Minimally Invasive Surgery"]
    },
    {
      name: "Dr. Rajapandian Subbiah",
      specialization: "Director, Institute of Bariatric & Metabolic Surgery",
      experience: "22+ years",
      patientsTreated: "5,000+",
      rating: "4.9",
      reviews: "310",
      image: "/dr-dr-aditya-gupta.jpg",
      qualifications: "MBBS, MS, DNB, Fellowship in Bariatric Surgery",
      expertise: ["Bariatric Surgery", "Metabolic Surgery", "Robotic Surgery"]
    },
    {
      name: "Dr. Mahesh Gopashetty",
      specialization: "Senior Consultant, GI Surgery",
      experience: "20+ years",
      patientsTreated: "4,500+",
      rating: "4.7",
      reviews: "240",
      image: "/dr-dr-i-p-s-oberoi.jpg",
      qualifications: "MBBS, MS, DNB, Fellowship in Advanced GI Surgery",
      expertise: ["Laparoscopic GI Surgery", "Hernia Surgery", "GI Oncology"]
    },
    {
      name: "Dr. Deepa Tayal",
      specialization: "Senior Consultant, Gastroenterology & Therapeutic Endoscopy",
      experience: "18+ years",
  ...
  const testimonials = [
    {
      ...
      age: 62,
      country: "UK",
      treatment: "Laparoscopic Colorectal Surgery for Colon Cancer",
      rating: 5,
      story: "After my colon cancer diagnosis, I researched treatment options globally and chose Apollo Chennai for their expertise in colorectal surgery. Dr. Venkatesh performed a laparoscopic procedure that resulted in minimal scarring and faster recovery than I expected.",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face",
      date: "Dec 2024",
      doctor: "Dr. Venkatesh Munikrishnan"
    },
    {
      name: "Fatima Al-Mansouri",
      age: 38,
      country: "UAE",
      treatment: "Bariatric Surgery - Gastric Bypass",
      rating: 5,
      story: "After struggling with obesity and related health issues for years, I decided to undergo bariatric surgery. I chose Apollo Hospitals after thorough research and consultation with Dr. Rajapandian. The robotic-assisted gastric bypass was performed with minimal discomfort.",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Rajapandian Subbiah"
    },
    {
      name: "John Peterson",
      age: 67,
      country: "Canada",
      treatment: "Liver Resection for Metastatic Colorectal Cancer",
      rating: 5,
      story: "After being diagnosed with colorectal cancer that had spread to my liver, I researched treatment options worldwide. Apollo's reputation for liver surgery led me to Dr. Anand Khakhar. The multidisciplinary approach was impressive.",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Anand Khakhar"
    },
    {
      ...
      rating: 5,
      story: "I had been suffering from a complex ventral hernia that had recurred after previous surgeries. After consulting with several surgeons in Europe, I was referred to Apollo Hospitals and Dr. Mahesh Gopashetty.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Mahesh Gopashetty"
    },
    {
      name: "Michael Chen",
      age: 59,
      country: "Singapore",
      treatment: "ERCP for Bile Duct Stones and Stricture",
      rating: 5,
      story: "I was diagnosed with complex bile duct stones and a stricture that required specialized intervention. After researching options in Asia, I chose Apollo Hospitals for Dr. Deepa Tayal's expertise in therapeutic endoscopy.",
      image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Deepa Tayal"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              <div className="flex items-center space-x-2 text-sm text-gray-600 mb-6">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-teal-600 font-medium">GI Surgery</span>
              </div>
              
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">GI Surgery Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  World-class gastrointestinal surgical care with cutting-edge technology and internationally trained specialists at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/apollo.png" 
                    alt="Apollo Hospital - World-Class GI Surgery Excellence" 
                  ...
                  <div className="absolute top-4 left-4 bg-teal-500 text-white px-3 py-1 rounded-full text-xs font-bold">
                    🏆 GI Surgery Excellence
                  </div>
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Apollo Hospital</h3>
                    <p className="text-sm opacity-90">GI Surgery Center of Excellence</p>
                  </div>
                </div>
                ...
                <div className="grid grid-rows-2 gap-4">
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="Advanced GI Surgery Equipment" 
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="World-Class GI Specialists" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">World-class Surgeons</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-xs text-gray-600">International Surgeons</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">98% Success</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">20 minutes from Chennai Airport</div>
                      <div className="text-sm text-gray-600">MAA Airport (Chennai) - Direct connectivity</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Thousand Lights Metro</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Greams Road, Chennai</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.123456789!2d80.2123456!3d13.0623456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a526e26aaaaaaab%3A0x404085140375fa29!2sApollo%20Hospitals%20Chennai!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      allowFullScreen="" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo GI Surgery Center of Excellence offers comprehensive gastrointestinal surgical care with cutting-edge technology and internationally trained specialists providing world-class treatment at affordable costs.
                </p>
                <p>
                  Our Institute of GI Sciences is equipped with the latest technology including robotic surgical systems and staffed by internationally trained specialists who perform both routine and complex GI surgeries with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive GI evaluation, advanced imaging studies, and multidisciplinary treatment planning with world-class expertise.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">GI Surgery</span>
                    </div>
                    {expandedSection === 'treatment' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced surgical procedures including minimally invasive, robotic, and complex GI surgeries with cutting-edge technology.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">Recovery & Follow-up</span>
                    </div>
                    {expandedSection === 'recovery' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-operative care, rehabilitation programs, and telemedicine follow-up with advanced monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to know more about ${treatment.name} at Apollo Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• World-class GI surgery with cutting-edge technology and international expertise</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Comprehensive GI evaluation</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Advanced GI surgical procedures</li>
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Medications & nutritional support</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Internationally trained GI surgery specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to book an appointment with ${doctor.name} for GI surgery consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Advanced GI surgical procedures require comprehensive travel insurance covering surgical procedures, complications, and emergency medical evacuation.
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <li>• Post-operative recovery and follow-up care is essential</li>
                  </ul>
                </div>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-sm text-gray-500">Consultation from $50</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for GI surgery consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for GI surgery at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>28+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $120/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">gi.surgery@apollohospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Greams Road, Chennai</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency GI surgery services with immediate response team and comprehensive surgical care
                </p>
                <button 
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>World-Class GI Surgery</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>International Surgeons</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default ApolloGISurgeryService;
