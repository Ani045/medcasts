  ...
  const treatments = [
    {
      ...
      cost: "$4,200 - $6,800",
      description: "Minimally invasive procedure to open blocked coronary arteries using advanced balloon catheter and stent placement",
      duration: "2-3 hours",
      stay: "2-3 days"
    },
    {
      ...
      cost: "$7,500 - $12,000",
      description: "Surgical procedure to create new pathways around blocked coronary arteries using premium grafts",
      duration: "4-6 hours",
      stay: "7-10 days"
    },
    {
    ...
    },
    {
      ...
      cost: "$5,600 - $9,400",
      description: "Implantation of electronic device to regulate heart rhythm and treat complex arrhythmias",
      duration: "1-2 hours",
      stay: "1-2 days"
    },
    {
      ...
      cost: "$4,900 - $8,200",
      description: "Minimally invasive closure of hole in heart wall between upper chambers using specialized devices",
      duration: "2-3 hours",
      stay: "2-3 days"
    },
    {
      ...
      cost: "$8,100 - $13,400",
      description: "Surgical repair of mitral valve to restore optimal blood flow function using advanced techniques",
      duration: "3-4 hours",
      stay: "6-8 days"
    },
    {
      ...
      cost: "$9,900 - $16,400",
      description: "Replacement of diseased aortic valve with prosthetic valve using advanced surgical methods",
      duration: "3-5 hours",
      stay: "8-12 days"
    },
    {
      ...
      cost: "$2,600 - $4,400",
      description: "Diagnostic procedure to examine heart function and blood vessels using advanced imaging technology",
      duration: "1-2 hours",
      stay: "1 day"
    }
  ];
  ...
  const doctors = [
    {
      ...
      expertise: ["Cardiac Surgery", "Bypass Surgery", "Valve Replacement"]
    },
    {
      ...
      expertise: ["Interventional Cardiology", "Angioplasty", "Cardiac Catheterization"]
    },
    {
      ...
      qualifications: "MBBS, MD, DM Cardiology, Fellowship in Electrophysiology",
      expertise: ["Electrophysiology", "Pacemaker Implantation", "Arrhythmia Treatment"]
    },
    {
      ...
      expertise: ["Pediatric Cardiac Surgery", "Congenital Heart Disease", "Pediatric Interventions"]
    },
    {
      name: "Dr. Anil Kumar",
      ...
      qualifications: "MBBS, MS, MCh Cardiothoracic Surgery",
      expertise: ["Heart Valve Surgery", "Minimally Invasive Surgery", "Cardiac Reconstruction"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Exceptional cardiac care at Sarvodaya Hospital. The angioplasty procedure was performed with outstanding precision and the medical team was world-class. Recovery was smooth and faster than expected.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Outstanding surgical expertise and comprehensive care. The valve replacement surgery was excellent and recovery was smooth with exceptional support from the cardiac team.",
      image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Rajiv Agarwal"
    },
    {
      name: "Ahmed Al-Farsi",
      age: 55,
      ...
      rating: 5,
      story: "World-class cardiac surgery center with exceptional facilities. The CABG procedure was performed with great expertise and outstanding post-operative care. Highly recommended.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Excellent cardiac care with advanced technology. Dr. Vikram Singh performed my pacemaker implantation with great skill. The entire team was professional and caring throughout my stay.",
    ...
    },
    {
      ...
      rating: 5,
      story: "Outstanding cardiac surgery experience at Sarvodaya Hospital. Dr. Anil Kumar performed my mitral valve repair with exceptional skill. The care and attention to detail was remarkable.",
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Institute of <span className="text-teal-600">Cardiovascular Sciences</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Leading cardiac care institution with advanced technology, compassionate specialists, and holistic approach to heart care at affordable costs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/sarvodaya.png" 
                    alt="Sarvodaya Hospital & Research Centre - Institute of Cardiovascular Sciences" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-90">Institute of Cardiovascular Sciences</p>
                  </div>
                </div>
                ...
                <div className="grid grid-rows-2 gap-4">
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="Advanced Cardiac Equipment" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">Cardiac Cath Labs</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    <img 
                      ...
                      alt="World-Class Cardiac Specialists" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        ...
                        <p className="text-xs opacity-90">Cardiac Specialists</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Cardiac Surgery</div>
                  <div className="text-xs text-gray-600">Advanced Procedures</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🩺</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Interventional</div>
                  <div className="text-xs text-gray-600">Minimally Invasive</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">📊</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">97% Success</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Sarvodaya Hospital & Research Centre Institute of Cardiovascular Sciences combines advanced medical technology with compassionate care, providing world-class cardiac treatment at affordable costs.
                </p>
                <p>
                  Our cardiac department is equipped with state-of-the-art facilities, advanced cardiac catheterization labs, and a team of highly skilled cardiac specialists performing both routine and complex cardiac procedures with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'consultation' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive cardiac evaluation, advanced imaging studies, and multidisciplinary treatment planning with experienced specialists.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-3 h-3 bg-teal-500 rounded-full mr-4"></div>
                      <span className="font-semibold text-lg">Cardiac Surgery</span>
                    </div>
                    {expandedSection === 'treatment' ? <ChevronUp className="w-5 h-5" /> : <ChevronDown className="w-5 h-5" />}
                  </button>
                  {expandedSection === 'treatment' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Advanced cardiac procedures including minimally invasive and complex surgeries with advanced technology and compassionate care.
                    </div>
                  )}
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {expandedSection === 'recovery' && (
                    <div className="px-5 pb-5 text-gray-600 leading-relaxed">
                      Comprehensive post-operative care, cardiac rehabilitation programs, and follow-up care with monitoring systems.
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="mt-6 bg-amber-50 rounded-xl p-4 border border-amber-200">
                ...
                <ul className="space-y-1 text-amber-700 text-sm">
                  <li>• Advanced cardiac care with cutting-edge technology and compassionate team</li>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    ...
                    <li>• Medications & lifestyle support</li>
            ...
            <div className="bg-gradient-to-br from-white to-teal-50 rounded-2xl shadow-lg p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600">Experienced cardiac specialists with proven expertise</p>
                </div>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/919811456789?text=Hi, I'd like to book an appointment with ${doctor.name} for cardiac consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Advanced cardiac procedures require comprehensive travel insurance covering surgical procedures, complications, and emergency medical evacuation.
                  </p>
                ...
                <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                  ...
                  <ul className="space-y-2 text-gray-700 text-sm">
                    ...
                    <li>• Bring all medical records, ECG reports, and previous cardiac imaging</li>
                    ...
                    <li>• Post-operative cardiac rehabilitation is essential for recovery</li>
                  </ul>
                </div>
                ...
                <div className="bg-blue-50 rounded-xl p-5 border border-blue-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-blue-700 text-sm">
                    ...
                    <div>
                      ...
                      <p>✓ 4.7/5 rating from 4,500+ patients</p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                <div className="text-center mb-5">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">$2,600</div>
                  <div className="text-sm text-gray-500">Consultation from $130</div>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for cardiac consultation at Sarvodaya Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for cardiac surgery at Sarvodaya Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                      <CheckCircle className="w-4 h-4 text-teal-600 mr-2 flex-shrink-0" />
                      <span className="font-medium">EMI options starting $130/month</span>
                    </div>
                  </div>
                  <div className="bg-teal-50 p-3 rounded-lg border border-teal-200">
                    <div className="flex items-center text-sm text-teal-800">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">cardiac@sarvodayahospital.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency cardiac services with immediate response team and comprehensive cardiac care
                </p>
                <button 
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Compassionate Cardiac Care</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                  ...
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Expert Cardiac Specialists</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default SarvodayaCardiacService;
