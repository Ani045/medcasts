  ...
  const doctors = [
    {
      ...
      qualifications: "MBBS, MD (Medicine), DM (Neurology), Fellowship (UK)",
    ...
    },
    {
      ...
      expertise: ["Minimally Invasive Spine Surgery", "Spinal Deformities", "Spinal Trauma"]
    },
    {
      name: "Dr. Mukesh Sharma",
      specialization: "Senior Consultant, Interventional Neurology",
      experience: "18+ years",
      patientsTreated: "6,000+",
      rating: "4.8",
      reviews: "280",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MD, DM (Neurology), Fellowship in Interventional Neurology",
      expertise: ["Stroke Intervention", "Aneurysm Treatment", "Carotid Stenting"]
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  Institute of <span className="text-teal-600">Neurosciences Excellence</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Comprehensive neurological and spine care with cutting-edge technology and internationally trained specialists at affordable costs.
                </p>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Apollo Institute of Neurosciences offers comprehensive neurological and spine care with cutting-edge technology and internationally trained specialists providing world-class treatment at affordable costs.
                </p>
                <p>
                  Our department is equipped with the latest technology including intraoperative neuronavigation, neuromonitoring, and advanced imaging, allowing our internationally trained specialists to perform both routine and complex neurological procedures with excellent outcomes.
                </p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I want to book an appointment for neurospine consultation at Apollo Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/919811456789?text=Hi, I need a cost estimate for neurospine surgery at Apollo Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">neurospine@apollohospitals.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
