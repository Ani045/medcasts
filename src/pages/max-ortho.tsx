...
const MaxOrthoService = () => {
  ...
  const doctors = [
    ...
    },
    {
      ...
      expertise: ["Spinal Deformity", "Disc Surgery", "Neuro-navigation"]
    },
    {
      name: "Dr. Priya Jaisingh",
    ...
    },
    {
      ...
      expertise: ["Knee Arthroscopy", "Shoulder Surgery", "Sports Injuries"]
    },
    {
      name: "Dr. Neeraj Gupta",
      specialization: "Computer-Assisted Surgery Specialist",
      experience: "21+ years",
      patientsTreated: "2,600+",
      rating: "4.8",
      reviews: "167",
      image: "/dr-dheeraj.jpeg",
      qualifications: "MBBS, MS Ortho, Fellowship Computer Navigation",
      expertise: ["Computer Navigation", "Precision Surgery", "Complex Cases"]
    }
  ];
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      story: "Dr. Rajesh Malhotra performed my hip replacement at Max Hospital with exceptional skill. The computer-assisted surgery was precise and my recovery was remarkable. The nursing staff provided excellent care and the rehabilitation program was comprehensive.",
    ...
    },
    {
      ...
      rating: 5,
      story: "After a serious accident, Dr. Priya Jaisingh saved my leg with expert trauma surgery at Max Hospital. The emergency response was immediate and the surgical outcome was excellent. I'm grateful for the world-class trauma care I received.",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face",
      date: "Nov 2024",
      doctor: "Dr. Priya Jaisingh"
    },
    {
      ...
      rating: 5,
      story: "Dr. Subhash Jangid performed complex spine surgery using neuro-navigation technology. The precision was incredible and my chronic back pain is completely gone. Max Hospital's spine center is truly world-class.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Oct 2024",
      doctor: "Dr. Subhash Jangid"
    },
    {
      ...
      rating: 5,
      story: "Dr. Amit Bhargava performed arthroscopic knee surgery with minimal invasion. The recovery was faster than expected and I'm back to my active lifestyle. The international patient services at Max were outstanding.",
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=100&h=100&fit=crop&crop=face",
      date: "Sep 2024",
      doctor: "Dr. Amit Bhargava"
    },
    {
      name: "Mr. Charles Miller",
      age: 56,
      country: "UK",
      treatment: "Computer-Assisted Surgery",
      rating: 5,
      story: "Dr. Neeraj Gupta used computer navigation for my complex joint replacement. The precision technology and personalized care at Max Hospital exceeded all expectations. I'm amazed by the advanced surgical capabilities and excellent outcomes.",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face",
      date: "Aug 2024",
      doctor: "Dr. Neeraj Gupta"
    }
  ];
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 via-white to-blue-50 rounded-2xl p-6 lg:p-8 shadow-lg">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                  World-Class <span className="text-teal-600">Computer-Assisted Surgery</span>
                </h1>
                <p className="text-base sm:text-lg text-gray-600 mb-4 leading-relaxed max-w-3xl">
                  Advanced joint replacement, trauma care, and spine surgery with computer-assisted precision technology.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="relative group overflow-hidden rounded-xl shadow-lg">
                  <img 
                    src="/Max hospital.png" 
                    alt="Max Super Speciality Hospital - Advanced Orthopaedic Care" 
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="font-bold text-lg">Max Super Speciality</h3>
                    <p className="text-sm opacity-90">Advanced Orthopedic Center</p>
                  </div>
                </div>
                  ...
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">💻 Computer Assisted</h4>
                        <p className="text-xs opacity-90">Precision Surgery</p>
                      </div>
                    </div>
                  </div>
                  <div className="relative group overflow-hidden rounded-xl shadow-lg">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/80 to-transparent flex items-center">
                      <div className="text-white p-4">
                        <h4 className="font-bold text-sm">🚑 Trauma Care</h4>
                        <p className="text-xs opacity-90">Emergency Excellence</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  ...
                  <div className="text-sm font-bold text-gray-900 mb-1">Computer Assisted</div>
                  <div className="text-xs text-gray-600">Precision Surgery</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🚑</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Trauma Care</div>
                  <div className="text-xs text-gray-600">Emergency Excellence</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🦴</div>
                  <div className="text-sm font-bold text-gray-900 mb-1">Spine Surgery</div>
                  <div className="text-xs text-gray-600">Neuro-navigation</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-shadow border border-teal-100">
                  <div className="text-2xl mb-2">🏆</div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Shalimar Bagh Metro Station</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-teal-50 rounded-lg border border-teal-100">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Shalimar Bagh, New Delhi</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  ...
                  <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.123456789!2d77.1523456!3d28.7123456!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d01aaaaaaab%3A0x404085140375fa29!2sMax%20Super%20Speciality%20Hospital!5e0!3m2!1sen!2sin!4v1755680098965!5m2!1sen!2sin"
                      width="100%" 
                      height="300" 
                      style={{ border: 0 }}
                      loading="lazy" 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Max Super Speciality Hospital's Orthopaedics Department is renowned for computer-assisted surgery, trauma care, and comprehensive joint replacement services with cutting-edge technology.
                </p>
                <p>
                  Our specialized teams in joint replacement, spine surgery, and trauma care provide world-class treatment with precision instruments and advanced rehabilitation programs.
                </p>
              </div>
            </div>
                ...
                {treatments.map((treatment, index) => (
                  <div key={index} className="bg-gradient-to-r from-white to-teal-50 border border-teal-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://wa.me/911129851000?text=Hi, I'd like to know more about ${treatment.name} at Max Super Speciality Hospital.`, '_blank')}
                    >
                      Get Quote
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <ul className="text-teal-700 space-y-2 text-sm">
                    <li>• Computer-assisted operation theater</li>
                          ...
                          .map((doctor, index) => (
                            <div key={index} className="bg-white rounded-lg p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-gray-100 group">
                              ...
                              <button 
                                ...
                                onClick={() => window.open(`https://wa.me/911129851000?text=Hi, I'd like to book an appointment with ${doctor.name} for orthopedic consultation.`, '_blank')}
                              >
                                Book Appointment
                              </button>
                            </div>
              ...
              <div className="space-y-6">
                <div className="bg-teal-50 rounded-xl p-5 border border-teal-100">
                  ...
                  <p className="text-teal-700 text-sm mb-3">
                    Computer-assisted orthopedic procedures require comprehensive travel insurance covering advanced surgical procedures, personal accidents, and emergency medical evacuation.
                  </p>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100">
                ...
                <div className="space-y-3 mb-5">
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911129851000?text=Hi, I want to book an appointment for orthopedic consultation at Max Super Speciality Hospital.', '_blank')}
                  >
                    Book Consultation
                  </button>
                  <button 
                    ...
                    onClick={() => window.open('https://wa.me/911129851000?text=Hi, I need a cost estimate for orthopedic treatment at Max Super Speciality Hospital.', '_blank')}
                  >
                    Get Cost Estimate
                  </button>
                </div>
                ...
                <div className="text-center text-sm text-gray-600 mb-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                  🔥 <strong>4+ other people</strong> are considering this treatment right now
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    ...
                    <span className="font-medium">+91 11 2985 1000</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <Mail className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">ortho@maxhealthcare.com</span>
                  </div>
                  <div className="flex items-center text-sm text-gray-600 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <MapPin className="w-4 h-4 mr-3 text-teal-600" />
                    <span className="font-medium">Shalimar Bagh, New Delhi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-2xl p-5">
                ...
                <p className="text-sm text-red-700 mb-4 leading-relaxed">
                  24/7 emergency orthopedic services with computer-assisted surgery capabilities and immediate trauma response team
                </p>
                <button 
                  ...
                  onClick={() => window.open('tel:+911129851000', '_blank')}
                >
                  Emergency: +91 11 2985 1000
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-200 rounded-2xl p-5">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span>Computer-Assisted Surgery</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
                    <span>Trauma Care Excellence</span>
                  </div>
                  <div className="flex items-center text-gray-700">
                    <div className="w-2 h-2 bg-teal-500 rounded-full mr-3"></div>
...
export default MaxOrthoService;
