...
const GISurgeryServicePage = () => {
  ...
  const giSurgeryHospitals = [
    {
      ...
      description: 'Leading GI surgery center with advanced laparoscopic expertise and comprehensive gastrointestinal treatments',
      rating: 4.9,
      reviews: 1850,
      specialties: ['Laparoscopic Surgery', 'Hepato-Biliary Surgery', 'GI Oncology'],
      accreditation: 'JCI Accredited',
      procedures: [
        { name: 'Cholecystectomy/Splenectomy', price: 2500, priceRange: '2500' },
        { name: 'Hernia Repair', price: 3500, priceRange: '3500' },
        { name: 'Lap Cholecystectomy', price: 1700, priceRange: '1700' },
        { name: 'Partial Hepatectomy', price: 10200, priceRange: '10200' }
      ],
      priceFrom: 1600,
      priceTo: 10200,
      priceFromText: '$1,600',
      ...
      successRate: '98.5%',
      treatments: ['Laparoscopic Surgery', 'Hepato-Biliary Surgery', 'GI Oncology'],
      services: ['JCI Accredited', 'Advanced Endoscopy', '24/7 Emergency Care', 'International Patient Services', 'Cholecystectomy', 'Hernia Repair', 'RIRS', 'Partial Hepatectomy'],
      features: ['Minimally Invasive Surgery', '24/7 Emergency Care', 'International Standards', 'Expert Care'],
      isTopRated: true
    },
    {
      id: 2,
      ...
      description: 'Multi-specialty GI institute with comprehensive digestive care and world-class surgical facilities',
      rating: 4.8,
      reviews: 2100,
      specialties: ['Complex GI Surgery', 'Liver Transplant', 'Bariatric Surgery'],
      accreditation: 'JCI Accredited',
      priceFrom: 1700,
      priceTo: 9200,
      priceFromText: '$1,700',
      ...
      services: ['JCI Accredited', 'Advanced Imaging', 'International Patient Services', 'LAP Fundoplication', 'Radical Nephrectomy', 'Roux en Y Hepaticojejunostomy'],
    ...
    },
    {
      ...
      description: 'Pioneer in gastrointestinal surgery with cutting-edge technology and world-renowned GI specialists',
      rating: 4.9,
      reviews: 1950,
      specialties: ['Minimally Invasive GI Surgery', 'Colorectal Surgery', 'Liver Surgery'],
      ...
      successRate: '98.8%',
      treatments: ['Minimally Invasive Surgery', 'Colorectal Surgery', 'Liver Surgery'],
      services: ['NABH Accredited', 'GI Oncology Center', 'Endoscopy Suite', 'Inguinal Hernia Repair', 'Anastomosis Surgery'],
    ...
    },
    {
      ...
      description: 'Excellence in gastrointestinal surgery with personalized care and advanced surgical programs',
      rating: 4.7,
      reviews: 1600,
      specialties: ['GI Surgery', 'Hepato-Pancreato-Biliary Surgery', 'GI Oncology'],
      accreditation: 'JCI Accredited',
      procedures: [
        { name: 'Left Hernioplasty Complex', price: 3000, priceRange: '3000' },
        { name: 'Inguinal Hernia Repair', price: 4500, priceRange: '4500' },
      ...
      services: ['JCI Accredited', '24/7 Emergency Care', 'International Patient Services', 'Splenectomy', 'LAP Fundoplication'],
    ...
    },
    {
      ...
      description: 'Specialized GI surgery center with comprehensive digestive care and advanced rehabilitation',
      rating: 4.6,
      reviews: 1300,
      ...
      services: ['NABH Accredited', 'Advanced Endoscopy', 'GI Oncology Unit', 'Cholecystectomy', 'Anastomosis Surgery'],
    ...
    },
    {
      ...
      description: 'Affordable excellence in GI surgical care with experienced surgeons and comprehensive treatment',
      rating: 4.4,
      reviews: 1050,
      ...
      successRate: '97.2%',
      treatments: ['GI Surgery', 'Laparoscopic Surgery', 'Endoscopic Procedures'],
      services: ['NABH Accredited', 'Endoscopy Center', '24/7 Emergency Care', 'Lap Chole', 'Radical Nephrectomy'],
  ...
  const doctors = [
    ...
    },
    {
      ...
      specialty: 'GI Surgeon & Liver Specialist',
  ...
  const giSurgeryPatientStories = [
    {
      ...
      story: "I had severe gallbladder stones causing intense pain. American doctors quoted $25,000 for laparoscopic surgery with a 2-month wait. Through Medcasts, I found Dr. Arvind Kumar at Artemis Hospital. The laparoscopic cholecystectomy was performed flawlessly with minimal scarring. I recovered within a week and was back to normal activities. The cost was 90% less than the US with superior care and faster recovery.",
