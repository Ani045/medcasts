...
const OrthopaedicHospitals = () => {
  ...
  const orthopaedicHospitals = [
  {
    ...
    description: 'Leading orthopaedic center with state-of-the-art robotic surgery and world-class joint replacement expertise',
    rating: 4.8,
    reviews: 1450,
    ...
    services: ['JCI Accredited', 'Robotic Surgery', '24/7 Emergency Care', 'International Patient Services', 'Unilateral THR', 'Bilateral THR', 'Unilateral TKR', 'Bilateral TKR'],
    features: ['Robotic Surgery', '24/7 Care', 'International Standards', 'Premium Care'],
    isTopRated: true
  },
  {
    id: 2,
    ...
    mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25100.674650325403!2d77.04207290095964!3d28.43925289094894!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d186ec89f751b%3A0xdc2ab32fc4675cac!2sMedanta%20-%20The%20Medicity%2C%20Gurugram!5e0!3m2!1sen!2sin!4v1756989645357!5m2!1sen!2sin',
    airportDistance: '45 min',
    description: 'Multi-specialty medical institute with comprehensive orthopaedic care and advanced surgical facilities',
    rating: 4.7,
    reviews: 2100,
    specialties: ['Orthopedic Oncology', 'Pediatric Orthopedics', 'Trauma Surgery'],
    accreditation: 'JCI Accredited',
    priceFrom: 4500,
    priceTo: 15000,
    priceFromText: '$4,500',
    ...
    successRate: '99.2%',
    treatments: ['Orthopedic Oncology', 'Trauma Surgery', 'Joint Replacement'],
    services: ['JCI Accredited', 'Advanced Imaging', 'International Patient Services', 'Key hole surgery to repair ligaments'],
  ...
  },
  {
    ...
    mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.9640329981867!2d77.28065237580833!3d28.54080077571503!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce6ad13eaaa99%3A0x3bc07ad476bc6d77!2sIndraprastha%20Apollo%20Hospital!5e0!3m2!1sen!2sin!4v1756991461879!5m2!1sen!2sin',
    airportDistance: '35 min',
    description: 'Pioneer in robotic orthopaedic surgery with cutting-edge technology and world-renowned specialists',
    rating: 4.9,
    reviews: 1800,
    specialties: ['Robotic Surgery', 'Minimally Invasive Procedures', 'Complex Spine'],
    ...
    successRate: '99.1%',
    treatments: ['Minimally Invasive Surgery', 'Spine Surgery', 'Joint Replacement'],
    services: ['NABH Accredited', 'Robotic Surgery', 'Physiotherapy Center', 'Comal Tunnal Dolands'],
  ...
  },
  {
    ...
    description: 'Excellence in joint replacement surgery with personalized care and advanced rehabilitation programs',
    rating: 4.5,
    reviews: 1600,
    ...
    services: ['JCI Accredited', '24/7 Emergency Care', 'International Patient Services', 'Bilateral THR', 'Bilateral TKR'],
  ...
  },
  {
    ...
    description: 'Specialized orthopaedic oncology center with comprehensive bone tumor treatment and rehabilitation',
    rating: 4.6,
    reviews: 1150,
    specialties: ['Bone Tumor Surgery', 'Deformity Correction', 'Hand Surgery'],
    accreditation: 'NABH Accredited',
    procedures: [
    ...
    successRate: '98.2%',
    treatments: ['Orthopedic Oncology', 'Trauma Surgery', 'Joint Replacement'],
    services: ['NABH Accredited', 'Advanced Imaging', 'Physiotherapy Center', 'Unilateral THR', 'Unilateral TKR'],
  ...
  },
  {
    ...
    description: 'Affordable excellence in orthopaedic care with experienced surgeons and comprehensive rehabilitation',
    rating: 4.3,
    reviews: 890,
    specialties: ['Fracture Treatment', 'Joint Reconstruction', 'Physiotherapy'],
    accreditation: 'NABH Accredited',
    priceFrom: 2800,
    priceTo: 7200,
    priceFromText: '$2,800',
    ...
    services: ['NABH Accredited', 'Physiotherapy Center', '24/7 Emergency Care', 'Key hole surgery to repair ligaments'],
  ...
  const orthoTreatmentTags = ['All', 'Joint Replacement', 'Spine Surgery', 'Sports Medicine', 'Hip Replacement', 'Complex Orthopedic', 'Pediatric Orthopedic'];
  ...
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex flex-col items-center text-center mb-12 md:flex-row md:justify-between md:items-center md:text-left">
      <div>
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Best Orthopaedic Doctors</h2>
        <p className="text-teal-700">Meet our expert orthopedic specialists with years of experience</p>
      </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="text-center">
      ...
      <div className="flex items-center justify-center mb-6 text-white">
        ...
        <span className="ml-3 text-teal-100 font-medium">(1,800 reviews)</span>
      </div>
        ...
        <div className="flex-1 flex flex-col p-6 lg:p-8 justify-between">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 mt-auto pt-3 border-t border-gray-100">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
              ...
              <button 
                onClick={() => {
                  if (hospital.name === 'Artemis Hospital') {
                    window.location.href = '/artemis-ortho';
                  } else if (hospital.name === 'Medanta – The Medicity') {
                    window.location.href = '/medanta-ortho';
                  } else if (hospital.name === 'Indraprastha Apollo Hospital') {
                    window.location.href = '/apollo-ortho';
                  } else if (hospital.name === 'Max Super Speciality Hospital') {
  ...
  <div className="bg-gradient-to-br from-teal-700 via-teal-600 to-teal-500 rounded-3xl p-8 text-white relative overflow-hidden max-h-[450px]">
    ...
    <div className="relative z-10 h-full flex flex-col justify-between">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-teal-100 text-sm">Get world-class treatment in 3 simple steps</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        <div className="mb-6 lg:mb-0">
          ...
          <p className="text-lg text-teal-700 max-w-2xl">
            Real patients sharing their transformative journeys from pain to mobility. Discover how advanced orthopedic care restored their active lives.
          </p>
        </div>
    ...
    {selectedPatient &&
        ...
        <div className="mt-16 bg-white rounded-3xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Unilateral THR</h4>
              <div className="text-2xl font-bold text-green-600 mb-2">$4,200</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $4,200 - $6,800</div>
            </div>
            
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Bilateral THR</h4>
              <div className="text-2xl font-bold text-blue-600 mb-2">$8,000</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $8,000 - $12,000</div>
            </div>
            
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Unilateral TKR</h4>
              <div className="text-2xl font-bold text-purple-600 mb-2">$3,800</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $3,800 - $5,500</div>
            </div>
            
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Bilateral TKR</h4>
              <div className="text-2xl font-bold text-orange-600 mb-2">$6,200</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $6,200 - $8,800</div>
            </div>
            
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Key hole surgery</h4>
              <div className="text-2xl font-bold text-teal-600 mb-2">$2,500</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $2,500 - $4,000</div>
            </div>
            
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Comal Tunnal Dolands</h4>
              <div className="text-2xl font-bold text-pink-600 mb-2">$1,800</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $1,800 - $3,200</div>
            </div>
          </div>
  ...
  <div className="relative z-10">
    ...
    <p className="text-teal-100 mb-8 text-lg max-w-2xl mx-auto">
      Get personalized treatment recommendations, cost estimates, and connect with our medical experts for a free consultation
    </p>
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
