...
const OncologyServicePage = () => {
  ...
  const oncologyHospitals = [
  {
    ...
    description: 'Premier cancer care center with advanced radiation therapy, precision oncology, and comprehensive cancer treatment programs',
    rating: 4.9,
    reviews: 1650,
    ...
    successRate: '92.5%',
    treatments: ['Medical Oncology', 'Radiation Oncology', 'Surgical Oncology'],
    services: ['JCI Accredited', 'Precision Medicine', 'Immunotherapy', 'IGRT', 'IMRT', 'Chemotherapy', 'Mastectomy'],
    features: ['Advanced Technology', 'Precision Medicine', 'Multidisciplinary Care', 'Research Programs'],
    isTopRated: true
  },
  {
    id: 2,
    ...
    description: 'Comprehensive cancer institute with cutting-edge surgical oncology and personalized treatment protocols',
    rating: 4.8,
    reviews: 2300,
    ...
    successRate: '91.8%',
    treatments: ['Surgical Oncology', 'Medical Oncology', 'Pediatric Oncology'],
    services: ['JCI Accredited', 'Robotic Surgery', 'Immunotherapy', 'RASTELLI Surgery', 'Surgical Oncology'],
  ...
  },
  {
    ...
    description: 'Leading cancer center with comprehensive radiation oncology and innovative treatment approaches',
    rating: 4.7,
    reviews: 1950,
    specialties: ['Radiation Oncology', 'Medical Oncology', 'Bone Marrow Transplant'],
    ...
    services: ['NABH Accredited', 'Radiation Therapy', 'BMT Center', 'Radiation Therapy', 'IGRT'],
  ...
  },
  {
    ...
    description: 'Excellence in cancer treatment with personalized oncology care and advanced treatment programs',
    rating: 4.6,
    reviews: 1700,
    ...
    { name: 'Whipples Surgery', price: 13500, priceRange: '13500-15000' },
    { name: 'Lumpectomy Surgery', price: 1600, priceRange: '1600-2000' }],
    ...
    services: ['JCI Accredited', '24/7 Emergency Care', 'International Patient Services', 'Chemotherapy', 'Whipples Surgery'],
  ...
  },
  {
    ...
    description: 'Specialized cancer center with comprehensive oncology care and advanced treatment protocols',
    rating: 4.5,
    reviews: 1400,
    specialties: ['Medical Oncology', 'Radiation Oncology', 'Surgical Oncology'],
    accreditation: 'NABH Accredited',
    ...
    { name: 'Lung Resection Surgery', price: 11000, priceRange: '11000-13000' }],
    ...
    successRate: '90.2%',
    treatments: ['Medical Oncology', 'Radiation Oncology', 'Surgical Oncology'],
    services: ['NABH Accredited', 'Advanced Imaging', 'Cancer Rehabilitation', 'IGRT', 'Lung Resection Surgery'],
  ...
  },
  {
    ...
    description: 'Affordable excellence in cancer care with experienced oncologists and comprehensive cancer treatment',
    rating: 4.3,
    reviews: 1200,
    specialties: ['Medical Oncology', 'Radiation Oncology', 'Surgical Oncology'],
    accreditation: 'NABH Accredited',
    ...
    successRate: '89.5%',
    treatments: ['Medical Oncology', 'Radiation Oncology', 'Surgical Oncology'],
    services: ['NABH Accredited', 'Cancer Rehabilitation', '24/7 Emergency Care', 'Radiation Therapy'],
  ...
  },
  {
    ...
    location: 'Gurgaon, India',
    story: "Stage 3 lung cancer required immediate intervention. Australian doctors estimated 6 months waiting time and AUD 180,000 in costs. My family found Medanta Hospital through Medcasts medical tourism. Dr. Vikram Singh performed a successful lung resection using minimally invasive video-assisted thoracoscopic surgery (VATS). The IMRT radiation therapy was precisely targeted using advanced imaging, minimizing damage to healthy lung tissue. The multi-disciplinary approach included pulmonologists, oncologists, and physiotherapists working together. Recovery was faster than expected - I was breathing normally within 2 weeks. Six months later, scans show no cancer recurrence. The comprehensive care and advanced technology at a fraction of Australian costs gave me my life back.",
    beforeAfter: true,
  ...
  },
  {
    ...
    procedure: 'Radical Hysterectomy + Chemotherapy',
    rating: 5,
    date: 'Jun 20, 2024',
    clinic: 'Amrita Hospital',
    location: 'Faridabad, India',
    story: "Cervical cancer at stage 2B required immediate complex surgery. Ethiopian medical facilities lacked advanced gynecologic oncology capabilities. Medcasts helped me find Amrita Hospital's specialized cancer program. Dr. Neha Agarwal performed a radical hysterectomy using minimally invasive robotic surgery. The precision was remarkable - complete tumor removal while preserving as much healthy tissue as possible. Post-surgery chemotherapy was administered using latest protocols with excellent supportive care to manage side effects. The international patient services team helped with everything from visa documentation to accommodation. Recovery was faster than expected due to the minimally invasive approach. Today, 10 months later, all scans are clear and I've returned to my work as a teacher. The specialized gynecologic oncology care and advanced surgical techniques gave me hope when local options couldn't help.",
    beforeAfter: true,
  ...
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex flex-col items-center text-center mb-12 md:flex-row md:justify-between md:items-center md:text-left">
      <div>
        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Best Oncology Specialists</h2>
        <p className="text-teal-700">Meet our expert oncologists with years of cancer treatment experience</p>
      </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="text-center">
      ...
      <div className="flex items-center justify-center mb-6 text-white">
        ...
        <span className="ml-3 text-teal-100 font-medium">(2,400 reviews)</span>
      </div>
        ...
        <div className="flex-1 flex flex-col p-6 lg:p-8 justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 mb-3">
              ...
              <div className="bg-teal-50 rounded-lg p-2 border border-teal-100">
                <div className="text-xs text-teal-600 uppercase tracking-wide font-semibold">Specialists</div>
                <div className="text-gray-900 font-medium text-sm flex items-center gap-1">
  ...
  <div className="bg-gradient-to-br from-teal-700 via-teal-600 to-teal-500 rounded-3xl p-8 text-white relative overflow-hidden max-h-[450px]">
    ...
    <div className="relative z-10 h-full flex flex-col justify-between">
      ...
      <div className="text-center mb-6">
        <h2 className="text-2xl lg:text-3xl font-bold mb-2">How Cancer Treatment Works</h2>
        <p className="text-teal-100 text-sm">Get world-class cancer care in 3 simple steps</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col md:flex-row items-center text-center md:text-left flex-1">
          ...
          <div>
            <h3 className="font-bold text-lg mb-1">Share Medical Reports</h3>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
        <div className="mb-6 lg:mb-0">
          ...
          <p className="text-lg text-teal-700 max-w-2xl">
            Real patients sharing their successful cancer treatment journeys. Discover how advanced oncology care helped them overcome cancer and reclaim their lives.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-3xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Chemotherapy</h4>
              <div className="text-2xl font-bold text-teal-600 mb-2">$3,500</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $3,500 - $8,000</div>
            </div>
            
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">IGRT</h4>
              <div className="text-2xl font-bold text-blue-600 mb-2">$5,500</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $5,500 - $6,000</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6">
              ...
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $4,500 - $5,000</div>
            </div>
            
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Mastectomy</h4>
              <div className="text-2xl font-bold text-orange-600 mb-2">$5,200</div>
              <div className="text-sm text-gray-600">Starting from</div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Whipples Surgery</h4>
              <div className="text-2xl font-bold text-pink-600 mb-2">$12,000</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $12,000 - $15,000</div>
            </div>
            
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6">
              <h4 className="font-bold text-gray-900 mb-3 text-lg">Lumpectomy Surgery</h4>
              <div className="text-2xl font-bold text-purple-600 mb-2">$1,600</div>
              <div className="text-sm text-gray-600">Starting from</div>
              <div className="text-xs text-gray-500 mt-2">Range: $1,600 - $2,000</div>
            </div>
          </div>
          
          <div className="text-center mt-6">
            <p className="text-sm text-gray-500">
              *Prices may vary based on hospital, cancer stage, and additional services required
            </p>
          </div>
        </div>
  ...
  <div className="relative z-10">
    ...
    <p className="text-teal-100 mb-8 text-lg max-w-2xl mx-auto">
      Get personalized cancer treatment plans, cost estimates, and connect with leading oncologists for a free consultation
    </p>
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      <button
                onClick={openQuoteForm}
