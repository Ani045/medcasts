  ...
  const neuroSpineHospitals = [
    {
      ...
      description: 'Leading neuro spine center with advanced neurosurgical expertise and cutting-edge brain and spine treatments',
      rating: 4.9,
      reviews: 1650,
      specialties: ['Brain Surgery', 'Spine Surgery', 'DBS Treatment'],
      accreditation: 'JCI Accredited',
      procedures: [
        { name: 'Single Level Decompression', price: 5500, priceRange: '5500-6500' },
        { name: 'Cranioplasty', price: 7500, priceRange: '7500-8000' },
        { name: 'Craniotomy', price: 6500, priceRange: '6500' },
        { name: 'DBS (Deep Brain Stimulation)', price: 20000, priceRange: '20000-35000' }
      ],
      priceFrom: 5500,
      priceTo: 35000,
      priceFromText: '$5,500',
      ...
      services: ['JCI Accredited', 'Advanced Neuro ICU', '24/7 Emergency Care', 'International Patient Services', 'Single Level Decompression', 'Cranioplasty', 'Deep Brain Stimulation', 'VP Shunt'],
      features: ['Advanced Neurosurgery', '24/7 Neuro ICU', 'International Standards', 'Expert Care'],
      isTopRated: true
    },
    {
      id: 2,
      ...
      description: 'Multi-specialty neuro institute with comprehensive brain and spine care and world-class surgical facilities',
      rating: 4.8,
      reviews: 2200,
      specialties: ['Complex Spine Surgery', 'Pediatric Neurosurgery', 'Skull Base Surgery'],
      accreditation: 'JCI Accredited',
      priceFrom: 6500,
      priceTo: 25000,
      priceFromText: '$6,500',
      ...
      successRate: '98.5%',
      treatments: ['Complex Spine Surgery', 'Brain Tumor Surgery', 'Epilepsy Surgery'],
      services: ['JCI Accredited', 'Advanced Imaging', 'International Patient Services', 'Craniotomy', 'Epilepsy Surgery', 'Baclofen Pump'],
    ...
    },
    {
      ...
      description: 'Pioneer in neurosurgery with cutting-edge technology and world-renowned neurosurgical specialists',
      rating: 4.9,
      reviews: 1900,
      specialties: ['Robotic Neurosurgery', 'Minimally Invasive Spine', 'Gamma Knife'],
      ...
      successRate: '98.9%',
      treatments: ['Minimally Invasive Surgery', 'Brain Surgery', 'Spine Surgery'],
      services: ['NABH Accredited', 'Gamma Knife Center', 'Neuro Rehabilitation', 'Cervical Discectomy', 'VP Shunt'],
    ...
    },
    {
      ...
      description: 'Excellence in neurosurgery with personalized care and advanced neuro rehabilitation programs',
      rating: 4.7,
      reviews: 1700,
      specialties: ['Spine Surgery', 'Brain Tumor Surgery', 'Neurovascular Surgery'],
      accreditation: 'JCI Accredited',
      procedures: [
        { name: 'Anterior Cervical Discectomy', price: 5500, priceRange: '5500-6500' },
      ...
      services: ['JCI Accredited', '24/7 Emergency Care', 'International Patient Services', 'Fusion Surgery', 'Epilepsy Surgery'],
    ...
    },
    {
      ...
      description: 'Specialized neurosurgery center with comprehensive brain and spine treatment and rehabilitation',
      rating: 4.6,
      reviews: 1200,
      specialties: ['Complex Spine Surgery', 'Pediatric Neurosurgery', 'Neuro Oncology'],
      accreditation: 'NABH Accredited',
      priceFrom: 6500,
      priceTo: 20000,
      priceFromText: '$6,500',
      ...
      services: ['NABH Accredited', 'Advanced Imaging', 'Neuro Rehabilitation', 'Single Level Decompression', 'Craniotomy'],
    ...
    },
    {
      ...
      description: 'Affordable excellence in neurosurgical care with experienced surgeons and comprehensive rehabilitation',
      rating: 4.4,
      reviews: 950,
      ...
      services: ['NABH Accredited', 'Neuro Rehabilitation', '24/7 Emergency Care', 'Cervical Discectomy', 'Fusion Surgery'],
  ...
  const sortedHospitals = [...filteredHospitals].sort((a, b) => {
    ...
    switch (sortBy) {
      case 'Price: Low to High':
        return parseInt(a.priceFromText.replace(/[$,]/g, '')) - parseInt(b.priceFromText.replace(/[$,]/g, ''));
      case 'Price: High to Low':
        return parseInt(b.priceFromText.replace(/[$,]/g, '')) - parseInt(a.priceFromText.replace(/[$,]/g, ''));
      case 'Highest Rated':
      ...
      <section className="py-12 bg-gradient-to-br from-teal-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-12 md:flex-row md:justify-between md:items-center md:text-left">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Best Neuro Spine Doctors</h2>
              <p className="text-teal-700">Meet our expert neurosurgeons with years of experience</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center mb-6 text-white">
              ...
              <span className="ml-3 text-teal-100 font-medium">(1,650 reviews)</span>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
                ...
                <div className="flex flex-col items-center text-center group">
                  ...
                  <p className="text-teal-100 text-sm max-w-xs">
                    Receive personalized neuro spine treatment plan from specialists
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Real <span className="text-teal-600">Neuro Spine Success Stories</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how our patients transformed their lives through world-class neuro spine treatment in India
            </p>
          </div>
              ...
              {Array.from({ length: totalTestimonialSlides }).map((_, slideIndex) => (
                <div key={slideIndex} className="w-full flex-shrink-0">
                  <div className={`grid gap-6 ${getTestimonialGridCols()}`}>
                    {filteredPatients
                      .slice(slideIndex * testimonialCardsPerSlide, (slideIndex + 1) * testimonialCardsPerSlide)
                      .map((patient) => (
                        <div
                          key={patient.id}
        ...
        <div className="mt-16 text-center bg-gradient-to-br from-teal-600 via-teal-500 to-emerald-600 rounded-3xl p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-teal-100 mb-8 text-lg max-w-2xl mx-auto">
              Get personalized treatment recommendations, cost estimates, and connect with our neuro spine experts for a free consultation
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={openQuoteForm}
